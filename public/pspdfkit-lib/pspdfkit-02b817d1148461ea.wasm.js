var PSPDFModuleInit = (function () {
  ...
  return (
    ...
    function (PSPDFModuleInit) {
      ...
      var Module = void 0 !== PSPDFModuleInit ? PSPDFModuleInit : {},
        readyPromiseResolve,
        readyPromiseReject
      ;(Module.ready = new Promise(function (g, A) {
        ;(readyPromiseResolve = g), (readyPromiseReject = A)
      })),
        ...
        (function (g) {
          function A() {
            Module.FS_createPath('/', 'assets', !0, !0),
              Module.FS_createPath('/assets', 'JavaScript', !0, !0),
              Module.FS_createPath('/assets', 'Signatures', !0, !0),
              Module.FS_createPath('/assets', 'NoteIcons', !0, !0),
          ...
          Module.calledRun ? A() : (Module.preRun || (Module.preRun = []), Module.preRun.push(A))
        })()
      var moduleOverrides = {},
        key
      ...
      function locateFile(g) {
        return Module.locateFile ? Module.locateFile(g, scriptDirectory) : scriptDirectory + g
      }
      ENVIRONMENT_IS_NODE
        ? ((scriptDirectory = ENVIRONMENT_IS_WORKER ? require('path').dirname(scriptDirectory) + '/' : __dirname + '/'),
          (read_ = function (g, A) {
            return (
              ...
              (g = nodePath.normalize(g)),
              nodeFS.readFileSync(g, A ? null : 'utf8')
            )
          }),
          (readBinary = function (g) {
            var A = read_(g, !0)
            return A.buffer || (A = new Uint8Array(A)), assert(A.buffer), A
          }),
          (readAsync = function (g, A, I) {
            nodeFS || (nodeFS = require('fs')),
              nodePath || (nodePath = require('path')),
              (g = nodePath.normalize(g)),
              nodeFS.readFile(g, function (g, C) {
                g ? I(g) : A(C.buffer)
              })
          }),
          ...
          process.on('uncaughtException', function (g) {
            if (!(g instanceof ExitStatus)) throw g
          }),
          process.on('unhandledRejection', abort),
          (quit_ = function (g, A) {
            if (keepRuntimeAlive()) throw ((process.exitCode = g), A)
            process.exit(g)
          }),
        ...
        : (ENVIRONMENT_IS_WEB || ENVIRONMENT_IS_WORKER) &&
          ...
          (read_ = function (g) {
            ...
            return A.open('GET', g, !1), A.send(null), A.responseText
          }),
          ENVIRONMENT_IS_WORKER &&
            (readBinary = function (g) {
              var A = new XMLHttpRequest()
          ...
          (readAsync = function (g, A, I) {
            ...
            C.open('GET', g, !0),
              ...
              (C.onload = function () {
                200 == C.status || (0 == C.status && C.response) ? A(C.response) : I()
              }),
              (C.onerror = I),
              C.send(null)
          }),
          (setWindowTitle = function (g) {
            document.title = g
          }))
      ...
      var ABORT = !1,
        EXITSTATUS
      function assert(g, A) {
        g || abort('Assertion failed: ' + A)
      }
      var UTF8Decoder = 'undefined' != typeof TextDecoder ? new TextDecoder('utf8') : void 0
      function UTF8ArrayToString(g, A, I) {
        for (var C = A + I, e = A; g[e] && !(e >= C); ) ++e
        if (e - A > 16 && g.subarray && UTF8Decoder) return UTF8Decoder.decode(g.subarray(A, e))
        for (var t = ''; A < e; ) {
          var n = g[A++]
          if (128 & n) {
            var i = 63 & g[A++]
            ...
            } else t += String.fromCharCode(((31 & n) << 6) | i)
          } else t += String.fromCharCode(n)
        }
        return t
      }
      function UTF8ToString(g, A) {
        return g ? UTF8ArrayToString(HEAPU8, g, A) : ''
      }
      function stringToUTF8Array(g, A, I, C) {
        if (!(C > 0)) return 0
        for (var e = I, t = I + C - 1, n = 0; n < g.length; ++n) {
          var i = g.charCodeAt(n)
          if (i >= 55296 && i <= 57343) i = (65536 + ((1023 & i) << 10)) | (1023 & g.charCodeAt(++n))
          if (i <= 127) {
            if (I >= t) break
            A[I++] = i
          } else if (i <= 2047) {
            if (I + 1 >= t) break
            ;(A[I++] = 192 | (i >> 6)), (A[I++] = 128 | (63 & i))
          } else if (i <= 65535) {
            if (I + 2 >= t) break
            ;(A[I++] = 224 | (i >> 12)), (A[I++] = 128 | ((i >> 6) & 63)), (A[I++] = 128 | (63 & i))
          } else {
            if (I + 3 >= t) break
            ;(A[I++] = 240 | (i >> 18)),
              (A[I++] = 128 | ((i >> 12) & 63)),
      ...
      function stringToUTF8(g, A, I) {
        return stringToUTF8Array(g, HEAPU8, A, I)
      }
      function lengthBytesUTF8(g) {
        for (var A = 0, I = 0; I < g.length; ++I) {
          var C = g.charCodeAt(I)
          C >= 55296 && C <= 57343 && (C = (65536 + ((1023 & C) << 10)) | (1023 & g.charCodeAt(++I))),
            C <= 127 ? ++A : (A += C <= 2047 ? 2 : C <= 65535 ? 3 : 4)
        }
        return A
      }
      var UTF16Decoder = 'undefined' != typeof TextDecoder ? new TextDecoder('utf-16le') : void 0,
        ...
        HEAPF32,
        HEAPF64
      function UTF16ToString(g, A) {
        for (var I = g, C = I >> 1, e = C + A / 2; !(C >= e) && HEAPU16[C]; ) ++C
        if ((I = C << 1) - g > 32 && UTF16Decoder) return UTF16Decoder.decode(HEAPU8.subarray(g, I))
        for (var t = '', n = 0; !(n >= A / 2); ++n) {
          var i = HEAP16[(g + 2 * n) >> 1]
          if (0 == i) break
          t += String.fromCharCode(i)
        }
        return t
      }
      function stringToUTF16(g, A, I) {
        if ((void 0 === I && (I = 2147483647), I < 2)) return 0
        for (var C = A, e = (I -= 2) < 2 * g.length ? I / 2 : g.length, t = 0; t < e; ++t) {
          var n = g.charCodeAt(t)
          ;(HEAP16[A >> 1] = n), (A += 2)
        }
        return (HEAP16[A >> 1] = 0), A - C
      }
      function lengthBytesUTF16(g) {
        return 2 * g.length
      }
      function UTF32ToString(g, A) {
        for (var I = 0, C = ''; !(I >= A / 4); ) {
          var e = HEAP32[(g + 4 * I) >> 2]
          if (0 == e) break
          if ((++I, e >= 65536)) {
            var t = e - 65536
            C += String.fromCharCode(55296 | (t >> 10), 56320 | (1023 & t))
          } else C += String.fromCharCode(e)
        }
        return C
      }
      function stringToUTF32(g, A, I) {
        if ((void 0 === I && (I = 2147483647), I < 4)) return 0
        for (var C = A, e = C + I - 4, t = 0; t < g.length; ++t) {
          var n = g.charCodeAt(t)
          if (n >= 55296 && n <= 57343) n = (65536 + ((1023 & n) << 10)) | (1023 & g.charCodeAt(++t))
          if (((HEAP32[A >> 2] = n), (A += 4) + 4 > e)) break
        }
        return (HEAP32[A >> 2] = 0), A - C
      }
      function lengthBytesUTF32(g) {
        for (var A = 0, I = 0; I < g.length; ++I) {
          var C = g.charCodeAt(I)
      ...
      function allocateUTF8(g) {
        var A = lengthBytesUTF8(g) + 1,
          I = _malloc(A)
        return I && stringToUTF8Array(g, HEAP8, I, A), I
      }
      function writeArrayToMemory(g, A) {
        HEAP8.set(g, A)
      }
      function writeAsciiToMemory(g, A, I) {
        for (var C = 0; C < g.length; ++C) HEAP8[A++ >> 0] = g.charCodeAt(C)
        I || (HEAP8[A >> 0] = 0)
      }
      function alignUp(g, A) {
        return g % A > 0 && (g += A - (g % A)), g
      }
      function updateGlobalBufferAndViews(g) {
        ;(buffer = g),
          (Module.HEAP8 = HEAP8 = new Int8Array(g)),
          (Module.HEAP16 = HEAP16 = new Int16Array(g)),
          (Module.HEAP32 = HEAP32 = new Int32Array(g)),
          (Module.HEAPU8 = HEAPU8 = new Uint8Array(g)),
          (Module.HEAPU16 = HEAPU16 = new Uint16Array(g)),
          (Module.HEAPU32 = HEAPU32 = new Uint32Array(g)),
          (Module.HEAPF32 = HEAPF32 = new Float32Array(g)),
          (Module.HEAPF64 = HEAPF64 = new Float64Array(g))
      }
      ...
      function addOnPreRun(g) {
        __ATPRERUN__.unshift(g)
      }
      function addOnInit(g) {
        __ATINIT__.unshift(g)
      }
      function addOnPostRun(g) {
        __ATPOSTRUN__.unshift(g)
      }
      var runDependencies = 0,
        runDependencyWatcher = null,
        dependenciesFulfilled = null
      function getUniqueRunDependency(g) {
        return g
      }
      ...
      function abort(g) {
        Module.onAbort && Module.onAbort(g),
          err((g += '')),
          (ABORT = !0),
          (EXITSTATUS = 1),
          (g = 'abort(' + g + '). Build with -s ASSERTIONS=1 for more info.')
      ...
      var dataURIPrefix = 'data:application/octet-stream;base64,',
        ...
        tempDouble,
        tempI64
      function isDataURI(g) {
        return g.startsWith(dataURIPrefix)
      }
      function isFileURI(g) {
        return g.startsWith('file://')
      }
      function getBinary(g) {
        try {
          if (g == wasmBinaryFile && wasmBinary) return new Uint8Array(wasmBinary)
        ...
        if (!wasmBinary && (ENVIRONMENT_IS_WEB || ENVIRONMENT_IS_WORKER)) {
          if ('function' == typeof fetch && !isFileURI(wasmBinaryFile))
            return fetch(wasmBinaryFile, { credentials: 'same-origin' })
              .then(function (g) {
                if (!g.ok) throw "failed to load wasm binary file at '" + wasmBinaryFile + "'"
      ...
      function createWasm() {
        var g = { a: asmLibraryArg }
        function A(g, A) {
          var I = g.exports
          ;(Module.asm = I),
            updateGlobalBufferAndViews((wasmMemory = Module.asm.Vc).buffer),
            (wasmTable = Module.asm.jd),
            addOnInit(Module.asm.Wc),
        ...
        if ((addRunDependency('wasm-instantiate'), Module.instantiateWasm))
          try {
            ...
            return err('Module.instantiateWasm callback failed with error: ' + g), !1
          }
        return (
          (wasmBinary ||
          ...
          'function' != typeof fetch
            ? C(I)
            : fetch(wasmBinaryFile, { credentials: 'same-origin' }).then(function (A) {
                return WebAssembly.instantiateStreaming(A, g).then(I, function (g) {
                  return (
                    err('wasm streaming compile failed: ' + g), err('falling back to ArrayBuffer instantiation'), C(I)
                  )
                })
              })
      ...
      ;(wasmBinaryFile = 'pspdfkit.wasm'), isDataURI(wasmBinaryFile) || (wasmBinaryFile = locateFile(wasmBinaryFile))
      var ASM_CONSTS = {
        2865456: function () {
          return (
        ...
        2865812: function (g, A) {
          setTimeout(function () {
            console.error(UTF8ToString(g))
          }, A)
        },
        2865879: function (g) {
          setTimeout(function () {
        ...
        2866275: function () {
          if ('undefined' != typeof self && void 0 !== self.crypto && void 0 !== self.crypto.getRandomValues) {
            var g = new Uint32Array(1)
            return self.crypto.getRandomValues(g), g[0]
          }
        ...
        for (; g.length > 0; ) {
          ...
          if ('function' != typeof A) {
            ...
            'number' == typeof I
              ? void 0 === A.arg
                ? wasmTable.get(I)()
                : wasmTable.get(I)(A.arg)
              : I(void 0 === A.arg ? null : A.arg)
          } else A(Module)
        }
      }
      function _tzset() {
        if (!_tzset.called) {
          ...
          var g = new Date().getFullYear(),
            ...
            e = I.getTimezoneOffset(),
            t = Math.max(C, e)
          ;(HEAP32[__get_timezone() >> 2] = 60 * t), (HEAP32[__get_daylight() >> 2] = Number(C != e))
          var n = a(A),
            i = a(I),
            r = allocateUTF8(n),
            o = allocateUTF8(i)
          e < C
            ? ((HEAP32[__get_tzname() >> 2] = r), (HEAP32[(__get_tzname() + 4) >> 2] = o))
            : ((HEAP32[__get_tzname() >> 2] = o), (HEAP32[(__get_tzname() + 4) >> 2] = r))
        }
        function a(g) {
          var A = g.toTimeString().match(/\(([A-Za-z ]+)\)$/)
          return A ? A[1] : 'GMT'
        }
      }
      function _mktime(g) {
        ...
        var A = new Date(
          ...
          t = new Date(A.getFullYear(), 6, 1).getTimezoneOffset(),
          n = e.getTimezoneOffset(),
          i = Math.min(n, t)
        if (I < 0) HEAP32[(g + 32) >> 2] = Number(t != n && i == C)
        else if (I > 0 != (i == C)) {
          var r = Math.max(n, t),
            o = I > 0 ? i : r
          A.setTime(A.getTime() + 6e4 * (o - C))
        }
        HEAP32[(g + 24) >> 2] = A.getDay()
        var a = ((A.getTime() - e.getTime()) / 864e5) | 0
        return (
          (HEAP32[(g + 28) >> 2] = a),
          (HEAP32[g >> 2] = A.getSeconds()),
          (HEAP32[(g + 4) >> 2] = A.getMinutes()),
          (HEAP32[(g + 8) >> 2] = A.getHours()),
          (HEAP32[(g + 12) >> 2] = A.getDate()),
          (HEAP32[(g + 16) >> 2] = A.getMonth()),
          (A.getTime() / 1e3) | 0
        )
      }
      function ___asctime(g, A) {
        var I = HEAP32[g >> 2],
          C = HEAP32[(g + 4) >> 2],
          e = HEAP32[(g + 8) >> 2],
          t = HEAP32[(g + 12) >> 2],
        ...
        return (
          stringToUTF8(
            ['Sun', 'Mon', 'Tue', 'Wed', 'Thu', 'Fri', 'Sat'][HEAP32[(g + 24) >> 2]] +
              ' ' +
      ...
      function ___cxa_allocate_exception(g) {
        return _malloc(g + 16) + 16
      }
      function _atexit(g, A) {}
      function ExceptionInfo(g) {
        ;(this.excPtr = g),
          (this.ptr = g - 16),
          (this.set_type = function (g) {
            HEAP32[(this.ptr + 4) >> 2] = g
          }),
          (this.get_type = function () {
            return HEAP32[(this.ptr + 4) >> 2]
          }),
          (this.set_destructor = function (g) {
            HEAP32[(this.ptr + 8) >> 2] = g
          }),
          ...
          (this.set_caught = function (g) {
            ;(g = g ? 1 : 0), (HEAP8[(this.ptr + 12) >> 0] = g)
          }),
          (this.get_caught = function () {
            return 0 != HEAP8[(this.ptr + 12) >> 0]
          }),
          (this.set_rethrown = function (g) {
            ;(g = g ? 1 : 0), (HEAP8[(this.ptr + 13) >> 0] = g)
          }),
          (this.get_rethrown = function () {
            return 0 != HEAP8[(this.ptr + 13) >> 0]
          }),
          (this.init = function (g, A) {
            this.set_type(g), this.set_destructor(A), this.set_refcount(0), this.set_caught(!1), this.set_rethrown(!1)
          }),
          (this.add_ref = function () {
            var g = HEAP32[this.ptr >> 2]
            HEAP32[this.ptr >> 2] = g + 1
          }),
          (this.release_ref = function () {
            var g = HEAP32[this.ptr >> 2]
            return (HEAP32[this.ptr >> 2] = g - 1), 1 === g
          })
      }
      function CatchInfo(g) {
        ;(this.free = function () {
          ...
          (this.get_exception_ptr = function () {
            if (___cxa_is_pointer_type(this.get_exception_info().get_type())) return HEAP32[this.get_base_ptr() >> 2]
            var g = this.get_adjusted_ptr()
            return 0 !== g ? g : this.get_base_ptr()
          }),
          (this.get_exception_info = function () {
            return new ExceptionInfo(this.get_base_ptr())
          }),
          void 0 === g ? ((this.ptr = _malloc(8)), this.set_adjusted_ptr(0)) : (this.ptr = g)
      }
      var exceptionCaught = []
      function exception_addRef(g) {
        g.add_ref()
      }
      var uncaughtExceptionCount = 0
      function ___cxa_begin_catch(g) {
        var A = new CatchInfo(g),
          I = A.get_exception_info()
        return (
          I.get_caught() || (I.set_caught(!0), uncaughtExceptionCount--),
          I.set_rethrown(!1),
      ...
      function ___cxa_call_unexpected(g) {
        throw (err('Unexpected exception thrown, this is not properly supported - aborting'), (ABORT = !0), g)
      }
      var exceptionLast = 0
      function ___cxa_free_exception(g) {
        return _free(new ExceptionInfo(g).ptr)
      }
      function exception_decRef(g) {
        if (g.release_ref() && !g.get_rethrown()) {
          var A = g.get_destructor()
          A && wasmTable.get(A)(g.excPtr), ___cxa_free_exception(g.excPtr)
        }
      }
      function ___cxa_end_catch() {
        _setThrew(0)
        var g = exceptionCaught.pop()
        exception_decRef(g.get_exception_info()), g.free(), (exceptionLast = 0)
      }
      function ___resumeException(g) {
        var A = new CatchInfo(g),
          I = A.get_base_ptr()
        throw (exceptionLast || (exceptionLast = I), A.free(), I)
      }
      function ___cxa_find_matching_catch_2() {
        var g = exceptionLast
        if (!g) return setTempRet0(0), 0
        var A = new ExceptionInfo(g),
          I = A.get_type(),
          C = new CatchInfo()
        if ((C.set_base_ptr(g), C.set_adjusted_ptr(g), !I)) return setTempRet0(0), 0 | C.ptr
        for (var e = Array.prototype.slice.call(arguments), t = 0; t < e.length; t++) {
          var n = e[t]
          if (0 === n || n === I) break
          if (___cxa_can_catch(n, I, C.get_adjusted_ptr_addr())) return setTempRet0(n), 0 | C.ptr
        }
        return setTempRet0(I), 0 | C.ptr
      }
      ...
      function ___cxa_rethrow() {
        var g = exceptionCaught.pop()
        g || abort('no exception to throw')
        var A = g.get_exception_info(),
          I = g.get_base_ptr()
        throw (
          (A.get_rethrown()
            ? g.free()
            : (exceptionCaught.push(g), A.set_rethrown(!0), A.set_caught(!1), uncaughtExceptionCount++),
          (exceptionLast = I),
          I)
        )
      }
      function ___cxa_thread_atexit(g, A) {
        return _atexit(g, A)
      }
      function ___cxa_throw(g, A, I) {
        throw (new ExceptionInfo(g).init(A, I), (exceptionLast = g), uncaughtExceptionCount++, g)
      }
      function ___cxa_uncaught_exceptions() {
        return uncaughtExceptionCount
      }
      function _gmtime_r(g, A) {
        var I = new Date(1e3 * HEAP32[g >> 2])
        ;(HEAP32[A >> 2] = I.getUTCSeconds()),
          (HEAP32[(A + 4) >> 2] = I.getUTCMinutes()),
          (HEAP32[(A + 8) >> 2] = I.getUTCHours()),
          (HEAP32[(A + 12) >> 2] = I.getUTCDate()),
          (HEAP32[(A + 16) >> 2] = I.getUTCMonth()),
          (HEAP32[(A + 20) >> 2] = I.getUTCFullYear() - 1900),
          (HEAP32[(A + 24) >> 2] = I.getUTCDay()),
          (HEAP32[(A + 36) >> 2] = 0),
          (HEAP32[(A + 32) >> 2] = 0)
        var C = Date.UTC(I.getUTCFullYear(), 0, 1, 0, 0, 0, 0),
          e = ((I.getTime() - C) / 864e5) | 0
        return (
          (HEAP32[(A + 28) >> 2] = e),
          _gmtime_r.GMTString || (_gmtime_r.GMTString = allocateUTF8('GMT')),
          (HEAP32[(A + 40) >> 2] = _gmtime_r.GMTString),
          A
        )
      }
      function ___gmtime_r(g, A) {
        return _gmtime_r(g, A)
      }
      function _localtime_r(g, A) {
        _tzset()
        var I = new Date(1e3 * HEAP32[g >> 2])
        ;(HEAP32[A >> 2] = I.getSeconds()),
          (HEAP32[(A + 4) >> 2] = I.getMinutes()),
          (HEAP32[(A + 8) >> 2] = I.getHours()),
          (HEAP32[(A + 12) >> 2] = I.getDate()),
          (HEAP32[(A + 16) >> 2] = I.getMonth()),
          (HEAP32[(A + 20) >> 2] = I.getFullYear() - 1900),
          (HEAP32[(A + 24) >> 2] = I.getDay())
        var C = new Date(I.getFullYear(), 0, 1),
          e = ((I.getTime() - C.getTime()) / 864e5) | 0
        ;(HEAP32[(A + 28) >> 2] = e), (HEAP32[(A + 36) >> 2] = -60 * I.getTimezoneOffset())
        var t = new Date(I.getFullYear(), 6, 1).getTimezoneOffset(),
          n = C.getTimezoneOffset(),
          i = 0 | (t != n && I.getTimezoneOffset() == Math.min(n, t))
        HEAP32[(A + 32) >> 2] = i
        var r = HEAP32[(__get_tzname() + (i ? 4 : 0)) >> 2]
        return (HEAP32[(A + 40) >> 2] = r), A
      }
      function ___localtime_r(g, A) {
        return _localtime_r(g, A)
      }
      function setErrNo(g) {
        return (HEAP32[___errno_location() >> 2] = g), g
      }
      function ___map_file(g, A) {
        return setErrNo(63), -1
      }
      var PATH = {
        splitPath: function (g) {
          return /^(\/?|)([\s\S]*?)((?:\.{1,2}|[^\/]+?|)(\.[^.\/]*|))(?:[\/]*)$/.exec(g).slice(1)
        },
        normalizeArray: function (g, A) {
          for (var I = 0, C = g.length - 1; C >= 0; C--) {
            var e = g[C]
            '.' === e ? g.splice(C, 1) : '..' === e ? (g.splice(C, 1), I++) : I && (g.splice(C, 1), I--)
          }
          if (A) for (; I; I--) g.unshift('..')
          return g
        },
        normalize: function (g) {
          var A = '/' === g.charAt(0),
            I = '/' === g.substr(-1)
          return (
            (g = PATH.normalizeArray(
              g.split('/').filter(function (g) {
                return !!g
              }),
              !A,
            ).join('/')) ||
        ...
        basename: function (g) {
          if ('/' === g) return '/'
          var A = (g = (g = PATH.normalize(g)).replace(/\/$/, '')).lastIndexOf('/')
          return -1 === A ? g : g.substr(A + 1)
        },
        extname: function (g) {
          return PATH.splitPath(g)[3]
        },
        join: function () {
          var g = Array.prototype.slice.call(arguments, 0)
          return PATH.normalize(g.join('/'))
        },
        join2: function (g, A) {
          return PATH.normalize(g + '/' + A)
        },
      }
      ...
      var PATH_FS = {
          resolve: function () {
            for (var g = '', A = !1, I = arguments.length - 1; I >= -1 && !A; I--) {
              var C = I >= 0 ? arguments[I] : FS.cwd()
          ...
          relative: function (g, A) {
            function I(g) {
              for (var A = 0; A < g.length && '' === g[A]; A++);
              for (var I = g.length - 1; I >= 0 && '' === g[I]; I--);
              return A > I ? [] : g.slice(A, I - A + 1)
            }
            ;(g = PATH_FS.resolve(g).substr(1)), (A = PATH_FS.resolve(A).substr(1))
            for (
              var C = I(g.split('/')), e = I(A.split('/')), t = Math.min(C.length, e.length), n = t, i = 0;
              i < t;
              i++
            )
              if (C[i] !== e[i]) {
            ...
            var r = []
            for (i = n; i < C.length; i++) r.push('..')
            return (r = r.concat(e.slice(n))).join('/')
          },
        },
        TTY = {
          ttys: [],
          init: function () {},
          shutdown: function () {},
          register: function (g, A) {
            ;(TTY.ttys[g] = { input: [], output: [], ops: A }), FS.registerDevice(g, TTY.stream_ops)
          },
          stream_ops: {
            open: function (g) {
              var A = TTY.ttys[g.node.rdev]
              if (!A) throw new FS.ErrnoError(43)
              ;(g.tty = A), (g.seekable = !1)
            },
            close: function (g) {
              g.tty.ops.flush(g.tty)
            },
            flush: function (g) {
              g.tty.ops.flush(g.tty)
            },
            read: function (g, A, I, C, e) {
              if (!g.tty || !g.tty.ops.get_char) throw new FS.ErrnoError(60)
              for (var t = 0, n = 0; n < C; n++) {
                var i
                try {
                  i = g.tty.ops.get_char(g.tty)
                } catch (g) {
                  throw new FS.ErrnoError(29)
                }
                if (void 0 === i && 0 === t) throw new FS.ErrnoError(6)
                if (null == i) break
                t++, (A[I + n] = i)
              }
            ...
            write: function (g, A, I, C, e) {
              if (!g.tty || !g.tty.ops.put_char) throw new FS.ErrnoError(60)
              try {
                for (var t = 0; t < C; t++) g.tty.ops.put_char(g.tty, A[I + t])
              } catch (g) {
                throw new FS.ErrnoError(29)
              }
              return C && (g.node.timestamp = Date.now()), t
            },
          },
          default_tty_ops: {
            get_char: function (g) {
              if (!g.input.length) {
                ...
                if (ENVIRONMENT_IS_NODE) {
                  var I = Buffer.alloc(256),
                    C = 0
                  try {
                    C = nodeFS.readSync(process.stdin.fd, I, 0, 256, null)
                  } catch (g) {
                    if (!g.toString().includes('EOF')) throw g
                    C = 0
                  }
                  A = C > 0 ? I.slice(0, C).toString('utf-8') : null
                } else
                  'undefined' != typeof window && 'function' == typeof window.prompt
                    ? null !== (A = window.prompt('Input: ')) && (A += '\n')
                    : 'function' == typeof readline && null !== (A = readline()) && (A += '\n')
                if (!A) return null
                g.input = intArrayFromString(A, !0)
              }
              return g.input.shift()
            },
            put_char: function (g, A) {
              null === A || 10 === A
                ? (out(UTF8ArrayToString(g.output, 0)), (g.output = []))
                : 0 != A && g.output.push(A)
            },
            flush: function (g) {
              g.output && g.output.length > 0 && (out(UTF8ArrayToString(g.output, 0)), (g.output = []))
            },
          },
          default_tty1_ops: {
            put_char: function (g, A) {
              null === A || 10 === A
                ? (err(UTF8ArrayToString(g.output, 0)), (g.output = []))
                : 0 != A && g.output.push(A)
            },
            flush: function (g) {
              g.output && g.output.length > 0 && (err(UTF8ArrayToString(g.output, 0)), (g.output = []))
            },
          },
        }
      function zeroMemory(g, A) {
        HEAPU8.fill(0, g, g + A)
      }
      function alignMemory(g, A) {
        return Math.ceil(g / A) * A
      }
      function mmapAlloc(g) {
        g = alignMemory(g, 65536)
        var A = _memalign(65536, g)
        return A ? (zeroMemory(A, g), A) : 0
      }
      var MEMFS = {
        ops_table: null,
        mount: function (g) {
          ...
          return (
            FS.isDir(e.mode)
              ...
              ? ((e.node_ops = MEMFS.ops_table.file.node),
                ...
                (e.contents = null))
              : FS.isLink(e.mode)
              ? ((e.node_ops = MEMFS.ops_table.link.node), (e.stream_ops = MEMFS.ops_table.link.stream))
              : FS.isChrdev(e.mode) &&
                ((e.node_ops = MEMFS.ops_table.chrdev.node), (e.stream_ops = MEMFS.ops_table.chrdev.stream)),
            (e.timestamp = Date.now()),
            g && ((g.contents[A] = e), (g.timestamp = e.timestamp)),
            e
          )
        },
        getFileDataAsTypedArray: function (g) {
          return g.contents
            ? g.contents.subarray
              ? g.contents.subarray(0, g.usedBytes)
              : new Uint8Array(g.contents)
            : new Uint8Array(0)
        },
        expandFileStorage: function (g, A) {
          var I = g.contents ? g.contents.length : 0
          if (!(I >= A)) {
            ;(A = Math.max(A, (I * (I < 1048576 ? 2 : 1.125)) >>> 0)), 0 != I && (A = Math.max(A, 256))
            var C = g.contents
            ;(g.contents = new Uint8Array(A)), g.usedBytes > 0 && g.contents.set(C.subarray(0, g.usedBytes), 0)
          }
        },
        resizeFileStorage: function (g, A) {
          if (g.usedBytes != A)
            if (0 == A) (g.contents = null), (g.usedBytes = 0)
            else {
              var I = g.contents
              ;(g.contents = new Uint8Array(A)),
                I && g.contents.set(I.subarray(0, Math.min(A, g.usedBytes))),
                (g.usedBytes = A)
            }
        },
        node_ops: {
          getattr: function (g) {
            var A = {}
            return (
              (A.dev = FS.isChrdev(g.mode) ? g.id : 1),
              (A.ino = g.id),
              (A.mode = g.mode),
              (A.nlink = 1),
              (A.uid = 0),
              ...
              FS.isDir(g.mode)
                ...
                ? (A.size = g.usedBytes)
                : FS.isLink(g.mode)
                ? (A.size = g.link.length)
                : (A.size = 0),
              (A.atime = new Date(g.timestamp)),
              (A.mtime = new Date(g.timestamp)),
              (A.ctime = new Date(g.timestamp)),
              (A.blksize = 4096),
              (A.blocks = Math.ceil(A.size / A.blksize)),
              A
            )
          },
          setattr: function (g, A) {
            void 0 !== A.mode && (g.mode = A.mode),
              void 0 !== A.timestamp && (g.timestamp = A.timestamp),
              void 0 !== A.size && MEMFS.resizeFileStorage(g, A.size)
          },
          lookup: function (g, A) {
            throw FS.genericErrors[44]
          },
          mknod: function (g, A, I, C) {
            return MEMFS.createNode(g, A, I, C)
          },
          rename: function (g, A, I) {
            if (FS.isDir(g.mode)) {
              var C
              try {
                C = FS.lookupNode(A, I)
              } catch (g) {}
              if (C) for (var e in C.contents) throw new FS.ErrnoError(55)
            }
            delete g.parent.contents[g.name],
              (g.parent.timestamp = Date.now()),
              (g.name = I),
              (A.contents[I] = g),
              (A.timestamp = g.parent.timestamp),
              (g.parent = A)
          },
          unlink: function (g, A) {
            delete g.contents[A], (g.timestamp = Date.now())
          },
          rmdir: function (g, A) {
            var I = FS.lookupNode(g, A)
            for (var C in I.contents) throw new FS.ErrnoError(55)
            delete g.contents[A], (g.timestamp = Date.now())
          },
          readdir: function (g) {
            var A = ['.', '..']
            for (var I in g.contents) g.contents.hasOwnProperty(I) && A.push(I)
            return A
          },
          symlink: function (g, A, I) {
            var C = MEMFS.createNode(g, A, 41471, 0)
            return (C.link = I), C
          },
          readlink: function (g) {
            if (!FS.isLink(g.mode)) throw new FS.ErrnoError(28)
            return g.link
          },
        },
        stream_ops: {
          read: function (g, A, I, C, e) {
            var t = g.node.contents
            if (e >= g.node.usedBytes) return 0
            var n = Math.min(g.node.usedBytes - e, C)
            if (n > 8 && t.subarray) A.set(t.subarray(e, e + n), I)
            else for (var i = 0; i < n; i++) A[I + i] = t[e + i]
            return n
          },
          write: function (g, A, I, C, e, t) {
            if ((A.buffer === HEAP8.buffer && (t = !1), !C)) return 0
            var n = g.node
            if (((n.timestamp = Date.now()), A.subarray && (!n.contents || n.contents.subarray))) {
              if (t) return (n.contents = A.subarray(I, I + C)), (n.usedBytes = C), C
              if (0 === n.usedBytes && 0 === e) return (n.contents = A.slice(I, I + C)), (n.usedBytes = C), C
              if (e + C <= n.usedBytes) return n.contents.set(A.subarray(I, I + C), e), C
            }
            if ((MEMFS.expandFileStorage(n, e + C), n.contents.subarray && A.subarray))
              n.contents.set(A.subarray(I, I + C), e)
            else for (var i = 0; i < C; i++) n.contents[e + i] = A[I + i]
            return (n.usedBytes = Math.max(n.usedBytes, e + C)), C
          },
          llseek: function (g, A, I) {
            var C = A
            if ((1 === I ? (C += g.position) : 2 === I && FS.isFile(g.node.mode) && (C += g.node.usedBytes), C < 0))
              throw new FS.ErrnoError(28)
            return C
          },
          allocate: function (g, A, I) {
            MEMFS.expandFileStorage(g.node, A + I), (g.node.usedBytes = Math.max(g.node.usedBytes, A + I))
          },
          mmap: function (g, A, I, C, e, t) {
            if (0 !== A) throw new FS.ErrnoError(28)
            if (!FS.isFile(g.node.mode)) throw new FS.ErrnoError(43)
            var n,
              i,
              r = g.node.contents
            if (2 & t || r.buffer !== buffer) {
              if (
                ((C > 0 || C + I < r.length) &&
                  (r = r.subarray ? r.subarray(C, C + I) : Array.prototype.slice.call(r, C, C + I)),
                (i = !0),
                !(n = mmapAlloc(I)))
              )
                throw new FS.ErrnoError(48)
              HEAP8.set(r, n)
            } else (i = !1), (n = r.byteOffset)
            return { ptr: n, allocated: i }
          },
          msync: function (g, A, I, C, e) {
            if (!FS.isFile(g.node.mode)) throw new FS.ErrnoError(43)
            if (2 & e) return 0
            MEMFS.stream_ops.write(g, A, 0, C, I, !1)
            return 0
          },
        },
      }
      function asyncLoad(g, A, I, C) {
        var e = C ? '' : getUniqueRunDependency('al ' + g)
        readAsync(
          g,
          function (I) {
            assert(I, 'Loading data file "' + g + '" failed (no arrayBuffer).'),
              A(new Uint8Array(I)),
              e && removeRunDependency(e)
          },
          function (A) {
            if (!I) throw 'Loading data file "' + g + '" failed.'
            I()
          },
        ),
      ...
      var WORKERFS = {
          ...
          mount: function (g) {
            ...
            var A = WORKERFS.createNode(null, '/', WORKERFS.DIR_MODE, 0),
              I = {}
            function C(g) {
              for (var C = g.split('/'), e = A, t = 0; t < C.length - 1; t++) {
                var n = C.slice(0, t + 1).join('/')
                I[n] || (I[n] = WORKERFS.createNode(e, C[t], WORKERFS.DIR_MODE, 0)), (e = I[n])
              }
              return e
            }
            function e(g) {
            ...
            return (
              Array.prototype.forEach.call(g.opts.files || [], function (g) {
                WORKERFS.createNode(C(g.name), e(g.name), WORKERFS.FILE_MODE, 0, g, g.lastModifiedDate)
              }),
              (g.opts.blobs || []).forEach(function (g) {
                WORKERFS.createNode(C(g.name), e(g.name), WORKERFS.FILE_MODE, 0, g.data)
              }),
              (g.opts.packages || []).forEach(function (g) {
                g.metadata.files.forEach(function (A) {
                  var I = A.filename.substr(1)
                  WORKERFS.createNode(C(I), e(I), WORKERFS.FILE_MODE, 0, g.blob.slice(A.start, A.end))
                })
              }),
              A
            )
          },
          createNode: function (g, A, I, C, e, t) {
            var n = FS.createNode(g, A, I)
            return (
              (n.mode = I),
              (n.node_ops = WORKERFS.node_ops),
              (n.stream_ops = WORKERFS.stream_ops),
              (n.timestamp = (t || new Date()).getTime()),
              assert(WORKERFS.FILE_MODE !== WORKERFS.DIR_MODE),
              I === WORKERFS.FILE_MODE ? ((n.size = e.size), (n.contents = e)) : ((n.size = 4096), (n.contents = {})),
              g && (g.contents[A] = n),
              n
            )
          },
          node_ops: {
            getattr: function (g) {
              return {
                ...
                rdev: void 0,
                size: g.size,
                atime: new Date(g.timestamp),
                mtime: new Date(g.timestamp),
                ctime: new Date(g.timestamp),
                blksize: 4096,
                blocks: Math.ceil(g.size / 4096),
              }
            },
            setattr: function (g, A) {
              void 0 !== A.mode && (g.mode = A.mode), void 0 !== A.timestamp && (g.timestamp = A.timestamp)
            },
            lookup: function (g, A) {
          ...
          stream_ops: {
            read: function (g, A, I, C, e) {
              ...
              var t = g.node.contents.slice(e, e + C),
                n = WORKERFS.reader.readAsArrayBuffer(t)
              return A.set(new Uint8Array(n), I), t.size
            },
            write: function (g, A, I, C, e) {
              throw new FS.ErrnoError(29)
            },
            llseek: function (g, A, I) {
              var C = A
              if ((1 === I ? (C += g.position) : 2 === I && FS.isFile(g.node.mode) && (C += g.node.size), C < 0))
                throw new FS.ErrnoError(28)
              return C
            },
          },
        ...
        FS = {
          ...
          filesystems: null,
          syncFSRequests: 0,
          lookupPath: function (g, A) {
            if (((A = A || {}), !(g = PATH_FS.resolve(FS.cwd(), g)))) return { path: '', node: null }
            var I = { follow_mount: !0, recurse_count: 0 }
            for (var C in I) void 0 === A[C] && (A[C] = I[C])
            if (A.recurse_count > 8) throw new FS.ErrnoError(32)
            for (
              var e = PATH.normalizeArray(
                  g.split('/').filter(function (g) {
                    return !!g
                  }),
                  !1,
              ...
              if (r && A.parent) break
              if (
                ((t = FS.lookupNode(t, e[i])),
                (n = PATH.join2(n, e[i])),
                FS.isMountpoint(t) && (!r || (r && A.follow_mount)) && (t = t.mounted.root),
                !r || A.follow)
              )
                for (var o = 0; FS.isLink(t.mode); ) {
                  var a = FS.readlink(n)
                  if (
                    ((n = PATH_FS.resolve(PATH.dirname(n), a)),
                    (t = FS.lookupPath(n, { recurse_count: A.recurse_count }).node),
                    o++ > 40)
                  )
                    throw new FS.ErrnoError(32)
                }
            }
            return { path: n, node: t }
          },
          getPath: function (g) {
            for (var A; ; ) {
              if (FS.isRoot(g)) {
                var I = g.mount.mountpoint
                return A ? ('/' !== I[I.length - 1] ? I + '/' + A : I + A) : I
              }
              ;(A = A ? g.name + '/' + A : g.name), (g = g.parent)
            }
          },
          hashName: function (g, A) {
            for (var I = 0, C = 0; C < A.length; C++) I = ((I << 5) - I + A.charCodeAt(C)) | 0
            return ((g + I) >>> 0) % FS.nameTable.length
          },
          hashAddNode: function (g) {
            var A = FS.hashName(g.parent.id, g.name)
            ;(g.name_next = FS.nameTable[A]), (FS.nameTable[A] = g)
          },
          hashRemoveNode: function (g) {
            var A = FS.hashName(g.parent.id, g.name)
            if (FS.nameTable[A] === g) FS.nameTable[A] = g.name_next
            else
              for (var I = FS.nameTable[A]; I; ) {
                if (I.name_next === g) {
                  I.name_next = g.name_next
                  break
                }
                I = I.name_next
              }
          },
          lookupNode: function (g, A) {
            var I = FS.mayLookup(g)
            if (I) throw new FS.ErrnoError(I, g)
            for (var C = FS.hashName(g.id, A), e = FS.nameTable[C]; e; e = e.name_next) {
              var t = e.name
              if (e.parent.id === g.id && t === A) return e
            }
            return FS.lookup(g, A)
          },
          createNode: function (g, A, I, C) {
            var e = new FS.FSNode(g, A, I, C)
            return FS.hashAddNode(e), e
          },
          destroyNode: function (g) {
            FS.hashRemoveNode(g)
          },
          isRoot: function (g) {
            return g === g.parent
          },
          isMountpoint: function (g) {
            return !!g.mounted
          },
          isFile: function (g) {
            return 32768 == (61440 & g)
          },
          isDir: function (g) {
            return 16384 == (61440 & g)
          },
          isLink: function (g) {
            return 40960 == (61440 & g)
          },
          isChrdev: function (g) {
            return 8192 == (61440 & g)
          },
          isBlkdev: function (g) {
            return 24576 == (61440 & g)
          },
          isFIFO: function (g) {
            return 4096 == (61440 & g)
          },
          isSocket: function (g) {
            return 49152 == (49152 & g)
          },
          flagModes: { r: 0, 'r+': 2, w: 577, 'w+': 578, a: 1089, 'a+': 1090 },
          modeStringToFlags: function (g) {
            var A = FS.flagModes[g]
            if (void 0 === A) throw new Error('Unknown file open mode: ' + g)
            return A
          },
          flagsToPermissionString: function (g) {
            var A = ['r', 'w', 'rw'][3 & g]
            return 512 & g && (A += 'w'), A
          },
          nodePermissions: function (g, A) {
            return FS.ignorePermissions ||
              ((!A.includes('r') || 292 & g.mode) &&
                (!A.includes('w') || 146 & g.mode) &&
                (!A.includes('x') || 73 & g.mode))
              ? 0
              : 2
          },
          mayLookup: function (g) {
            var A = FS.nodePermissions(g, 'x')
            return A || (g.node_ops.lookup ? 0 : 2)
          },
          mayCreate: function (g, A) {
            try {
              FS.lookupNode(g, A)
              return 20
            } catch (g) {}
            return FS.nodePermissions(g, 'wx')
          },
          mayDelete: function (g, A, I) {
            var C
            try {
              C = FS.lookupNode(g, A)
            } catch (g) {
            ...
            var e = FS.nodePermissions(g, 'wx')
            if (e) return e
            if (I) {
              if (!FS.isDir(C.mode)) return 54
              if (FS.isRoot(C) || FS.getPath(C) === FS.cwd()) return 10
            } else if (FS.isDir(C.mode)) return 31
            return 0
          },
          mayOpen: function (g, A) {
            return g
              ? FS.isLink(g.mode)
                ? 32
                : FS.isDir(g.mode) && ('r' !== FS.flagsToPermissionString(A) || 512 & A)
                ? 31
                : FS.nodePermissions(g, FS.flagsToPermissionString(A))
              : 44
          },
          MAX_OPEN_FDS: 4096,
          nextfd: function (g, A) {
            ;(g = g || 0), (A = A || FS.MAX_OPEN_FDS)
            for (var I = g; I <= A; I++) if (!FS.streams[I]) return I
            throw new FS.ErrnoError(33)
          },
          getStream: function (g) {
            return FS.streams[g]
          },
          createStream: function (g, A, I) {
            FS.FSStream ||
            ...
            g = C
            var t = FS.nextfd(A, I)
            return (g.fd = t), (FS.streams[t] = g), g
          },
          closeStream: function (g) {
            FS.streams[g] = null
          },
          chrdev_stream_ops: {
            open: function (g) {
              var A = FS.getDevice(g.node.rdev)
              ;(g.stream_ops = A.stream_ops), g.stream_ops.open && g.stream_ops.open(g)
            },
            llseek: function () {
          ...
          makedev: function (g, A) {
            return (g << 8) | A
          },
          registerDevice: function (g, A) {
            FS.devices[g] = { stream_ops: A }
          },
          getDevice: function (g) {
            return FS.devices[g]
          },
          getMounts: function (g) {
            for (var A = [], I = [g]; I.length; ) {
              var C = I.pop()
              A.push(C), I.push.apply(I, C.mounts)
            }
            return A
          },
          syncfs: function (g, A) {
            'function' == typeof g && ((A = g), (g = !1)),
              FS.syncFSRequests++,
              FS.syncFSRequests > 1 &&
                err(
                  'warning: ' +
            ...
            var I = FS.getMounts(FS.root.mount),
              C = 0
            function e(g) {
              return FS.syncFSRequests--, A(g)
            }
            function t(g) {
              if (g) return t.errored ? void 0 : ((t.errored = !0), e(g))
              ++C >= I.length && e(null)
            }
            I.forEach(function (A) {
              if (!A.type.syncfs) return t(null)
              A.type.syncfs(A, g, t)
            })
          },
          mount: function (g, A, I) {
            var C,
              e = '/' === I,
              t = !I
            if (e && FS.root) throw new FS.ErrnoError(10)
            if (!e && !t) {
              var n = FS.lookupPath(I, { follow_mount: !1 })
              if (((I = n.path), (C = n.node), FS.isMountpoint(C))) throw new FS.ErrnoError(10)
              if (!FS.isDir(C.mode)) throw new FS.ErrnoError(54)
            }
            var i = { type: g, opts: A, mountpoint: I, mounts: [] },
              r = g.mount(i)
            return (
              (r.mount = i),
              (i.root = r),
              e ? (FS.root = r) : C && ((C.mounted = i), C.mount && C.mount.mounts.push(i)),
              r
            )
          },
          unmount: function (g) {
            var A = FS.lookupPath(g, { follow_mount: !1 })
            if (!FS.isMountpoint(A.node)) throw new FS.ErrnoError(28)
            var I = A.node,
              C = I.mounted,
              e = FS.getMounts(C)
            Object.keys(FS.nameTable).forEach(function (g) {
              for (var A = FS.nameTable[g]; A; ) {
                var I = A.name_next
                e.includes(A.mount) && FS.destroyNode(A), (A = I)
              }
            }),
              (I.mounted = null)
            var t = I.mount.mounts.indexOf(C)
            I.mount.mounts.splice(t, 1)
          },
          lookup: function (g, A) {
            return g.node_ops.lookup(g, A)
          },
          mknod: function (g, A, I) {
            var C = FS.lookupPath(g, { parent: !0 }).node,
              e = PATH.basename(g)
            if (!e || '.' === e || '..' === e) throw new FS.ErrnoError(28)
            var t = FS.mayCreate(C, e)
            if (t) throw new FS.ErrnoError(t)
            if (!C.node_ops.mknod) throw new FS.ErrnoError(63)
            return C.node_ops.mknod(C, e, A, I)
          },
          create: function (g, A) {
            return (A = void 0 !== A ? A : 438), (A &= 4095), (A |= 32768), FS.mknod(g, A, 0)
          },
          mkdir: function (g, A) {
            return (A = void 0 !== A ? A : 511), (A &= 1023), (A |= 16384), FS.mknod(g, A, 0)
          },
          mkdirTree: function (g, A) {
            for (var I = g.split('/'), C = '', e = 0; e < I.length; ++e)
              if (I[e]) {
                C += '/' + I[e]
                try {
                  FS.mkdir(C, A)
          ...
          mkdev: function (g, A, I) {
            return void 0 === I && ((I = A), (A = 438)), (A |= 8192), FS.mknod(g, A, I)
          },
          symlink: function (g, A) {
            if (!PATH_FS.resolve(g)) throw new FS.ErrnoError(44)
            var I = FS.lookupPath(A, { parent: !0 }).node
            if (!I) throw new FS.ErrnoError(44)
            var C = PATH.basename(A),
              e = FS.mayCreate(I, C)
            if (e) throw new FS.ErrnoError(e)
            if (!I.node_ops.symlink) throw new FS.ErrnoError(63)
            return I.node_ops.symlink(I, C, g)
          },
          rename: function (g, A) {
            var I,
              C,
              ...
              n = PATH.basename(g),
              i = PATH.basename(A)
            if (((I = FS.lookupPath(g, { parent: !0 }).node), (C = FS.lookupPath(A, { parent: !0 }).node), !I || !C))
              throw new FS.ErrnoError(44)
            if (I.mount !== C.mount) throw new FS.ErrnoError(75)
            var r,
              o = FS.lookupNode(I, n),
              a = PATH_FS.relative(g, t)
            if ('.' !== a.charAt(0)) throw new FS.ErrnoError(28)
            if ('.' !== (a = PATH_FS.relative(A, e)).charAt(0)) throw new FS.ErrnoError(55)
            try {
              r = FS.lookupNode(C, i)
            } catch (g) {}
            if (o !== r) {
              var l = FS.isDir(o.mode),
                c = FS.mayDelete(I, n, l)
              if (c) throw new FS.ErrnoError(c)
              if ((c = r ? FS.mayDelete(C, i, l) : FS.mayCreate(C, i))) throw new FS.ErrnoError(c)
              if (!I.node_ops.rename) throw new FS.ErrnoError(63)
              if (FS.isMountpoint(o) || (r && FS.isMountpoint(r))) throw new FS.ErrnoError(10)
              if (C !== I && (c = FS.nodePermissions(I, 'w'))) throw new FS.ErrnoError(c)
              try {
                FS.trackingDelegate.willMovePath && FS.trackingDelegate.willMovePath(g, A)
              } catch (I) {
                err("FS.trackingDelegate['willMovePath']('" + g + "', '" + A + "') threw an exception: " + I.message)
              }
              FS.hashRemoveNode(o)
              try {
                I.node_ops.rename(o, C, i)
              } catch (g) {
                throw g
              } finally {
                FS.hashAddNode(o)
              ...
              try {
                FS.trackingDelegate.onMovePath && FS.trackingDelegate.onMovePath(g, A)
              } catch (I) {
                err("FS.trackingDelegate['onMovePath']('" + g + "', '" + A + "') threw an exception: " + I.message)
              }
            }
          },
          rmdir: function (g) {
            var A = FS.lookupPath(g, { parent: !0 }).node,
              I = PATH.basename(g),
              C = FS.lookupNode(A, I),
              e = FS.mayDelete(A, I, !0)
            if (e) throw new FS.ErrnoError(e)
            if (!A.node_ops.rmdir) throw new FS.ErrnoError(63)
            if (FS.isMountpoint(C)) throw new FS.ErrnoError(10)
            try {
              FS.trackingDelegate.willDeletePath && FS.trackingDelegate.willDeletePath(g)
            } catch (A) {
              err("FS.trackingDelegate['willDeletePath']('" + g + "') threw an exception: " + A.message)
            }
            A.node_ops.rmdir(A, I), FS.destroyNode(C)
            try {
              FS.trackingDelegate.onDeletePath && FS.trackingDelegate.onDeletePath(g)
            } catch (A) {
              err("FS.trackingDelegate['onDeletePath']('" + g + "') threw an exception: " + A.message)
            }
          },
          readdir: function (g) {
            var A = FS.lookupPath(g, { follow: !0 }).node
            if (!A.node_ops.readdir) throw new FS.ErrnoError(54)
          ...
          unlink: function (g) {
            var A = FS.lookupPath(g, { parent: !0 }).node,
              I = PATH.basename(g),
              C = FS.lookupNode(A, I),
              e = FS.mayDelete(A, I, !1)
            if (e) throw new FS.ErrnoError(e)
            if (!A.node_ops.unlink) throw new FS.ErrnoError(63)
            if (FS.isMountpoint(C)) throw new FS.ErrnoError(10)
            try {
              FS.trackingDelegate.willDeletePath && FS.trackingDelegate.willDeletePath(g)
            } catch (A) {
            ...
            A.node_ops.unlink(A, I), FS.destroyNode(C)
            try {
              FS.trackingDelegate.onDeletePath && FS.trackingDelegate.onDeletePath(g)
            } catch (A) {
              err("FS.trackingDelegate['onDeletePath']('" + g + "') threw an exception: " + A.message)
          ...
          readlink: function (g) {
            var A = FS.lookupPath(g).node
            if (!A) throw new FS.ErrnoError(44)
            if (!A.node_ops.readlink) throw new FS.ErrnoError(28)
            return PATH_FS.resolve(FS.getPath(A.parent), A.node_ops.readlink(A))
          },
          stat: function (g, A) {
            var I = FS.lookupPath(g, { follow: !A }).node
            if (!I) throw new FS.ErrnoError(44)
            if (!I.node_ops.getattr) throw new FS.ErrnoError(63)
            return I.node_ops.getattr(I)
          },
          lstat: function (g) {
            return FS.stat(g, !0)
          },
          chmod: function (g, A, I) {
            var C
            'string' == typeof g ? (C = FS.lookupPath(g, { follow: !I }).node) : (C = g)
            if (!C.node_ops.setattr) throw new FS.ErrnoError(63)
            C.node_ops.setattr(C, { mode: (4095 & A) | (-4096 & C.mode), timestamp: Date.now() })
          },
          lchmod: function (g, A) {
            FS.chmod(g, A, !0)
          },
          fchmod: function (g, A) {
            var I = FS.getStream(g)
            if (!I) throw new FS.ErrnoError(8)
            FS.chmod(I.node, A)
          },
          chown: function (g, A, I, C) {
            var e
            'string' == typeof g ? (e = FS.lookupPath(g, { follow: !C }).node) : (e = g)
            if (!e.node_ops.setattr) throw new FS.ErrnoError(63)
            e.node_ops.setattr(e, { timestamp: Date.now() })
          },
          lchown: function (g, A, I) {
            FS.chown(g, A, I, !0)
          },
          fchown: function (g, A, I) {
            var C = FS.getStream(g)
            if (!C) throw new FS.ErrnoError(8)
            FS.chown(C.node, A, I)
          },
          truncate: function (g, A) {
            if (A < 0) throw new FS.ErrnoError(28)
            var I
            'string' == typeof g ? (I = FS.lookupPath(g, { follow: !0 }).node) : (I = g)
            ...
            var C = FS.nodePermissions(I, 'w')
            if (C) throw new FS.ErrnoError(C)
            I.node_ops.setattr(I, { size: A, timestamp: Date.now() })
          },
          ftruncate: function (g, A) {
            var I = FS.getStream(g)
            if (!I) throw new FS.ErrnoError(8)
            if (0 == (2097155 & I.flags)) throw new FS.ErrnoError(28)
            FS.truncate(I.node, A)
          },
          utime: function (g, A, I) {
            var C = FS.lookupPath(g, { follow: !0 }).node
            C.node_ops.setattr(C, { timestamp: Math.max(A, I) })
          },
          open: function (g, A, I, C, e) {
            if ('' === g) throw new FS.ErrnoError(44)
            var t
            if (
              ((I = void 0 === I ? 438 : I),
              (I = 64 & (A = 'string' == typeof A ? FS.modeStringToFlags(A) : A) ? (4095 & I) | 32768 : 0),
              'object' == typeof g)
            )
              t = g
            else {
              g = PATH.normalize(g)
              try {
                t = FS.lookupPath(g, { follow: !(131072 & A) }).node
              } catch (g) {}
            }
            var n = !1
            if (64 & A)
              if (t) {
                if (128 & A) throw new FS.ErrnoError(20)
              } else (t = FS.mknod(g, I, 0)), (n = !0)
            if (!t) throw new FS.ErrnoError(44)
            if ((FS.isChrdev(t.mode) && (A &= -513), 65536 & A && !FS.isDir(t.mode))) throw new FS.ErrnoError(54)
            if (!n) {
              var i = FS.mayOpen(t, A)
              if (i) throw new FS.ErrnoError(i)
            }
            512 & A && FS.truncate(t, 0), (A &= -131713)
            var r = FS.createStream(
              {
                node: t,
                path: FS.getPath(t),
                flags: A,
            ...
            r.stream_ops.open && r.stream_ops.open(r),
              !Module.logReadFiles ||
                ...
                g in FS.readFiles || ((FS.readFiles[g] = 1), err('FS.trackingDelegate error on read file: ' + g)))
            try {
              if (FS.trackingDelegate.onOpenFile) {
                var o = 0
                1 != (2097155 & A) && (o |= FS.tracking.openFlags.READ),
                  0 != (2097155 & A) && (o |= FS.tracking.openFlags.WRITE),
                  FS.trackingDelegate.onOpenFile(g, o)
              }
            } catch (A) {
              err("FS.trackingDelegate['onOpenFile']('" + g + "', flags) threw an exception: " + A.message)
            }
            return r
          },
          close: function (g) {
            if (FS.isClosed(g)) throw new FS.ErrnoError(8)
            g.getdents && (g.getdents = null)
            try {
              g.stream_ops.close && g.stream_ops.close(g)
            } catch (g) {
              throw g
            } finally {
              FS.closeStream(g.fd)
          ...
          llseek: function (g, A, I) {
            if (FS.isClosed(g)) throw new FS.ErrnoError(8)
            if (!g.seekable || !g.stream_ops.llseek) throw new FS.ErrnoError(70)
            if (0 != I && 1 != I && 2 != I) throw new FS.ErrnoError(28)
            return (g.position = g.stream_ops.llseek(g, A, I)), (g.ungotten = []), g.position
          },
          read: function (g, A, I, C, e) {
            if (C < 0 || e < 0) throw new FS.ErrnoError(28)
            if (FS.isClosed(g)) throw new FS.ErrnoError(8)
            if (1 == (2097155 & g.flags)) throw new FS.ErrnoError(8)
            if (FS.isDir(g.node.mode)) throw new FS.ErrnoError(31)
            if (!g.stream_ops.read) throw new FS.ErrnoError(28)
            var t = void 0 !== e
            if (t) {
              if (!g.seekable) throw new FS.ErrnoError(70)
            } else e = g.position
            var n = g.stream_ops.read(g, A, I, C, e)
            return t || (g.position += n), n
          },
          write: function (g, A, I, C, e, t) {
            if (C < 0 || e < 0) throw new FS.ErrnoError(28)
            if (FS.isClosed(g)) throw new FS.ErrnoError(8)
            if (0 == (2097155 & g.flags)) throw new FS.ErrnoError(8)
            if (FS.isDir(g.node.mode)) throw new FS.ErrnoError(31)
            if (!g.stream_ops.write) throw new FS.ErrnoError(28)
            g.seekable && 1024 & g.flags && FS.llseek(g, 0, 2)
            var n = void 0 !== e
            if (n) {
              if (!g.seekable) throw new FS.ErrnoError(70)
            } else e = g.position
            var i = g.stream_ops.write(g, A, I, C, e, t)
            n || (g.position += i)
            try {
              g.path && FS.trackingDelegate.onWriteToFile && FS.trackingDelegate.onWriteToFile(g.path)
            } catch (A) {
              err("FS.trackingDelegate['onWriteToFile']('" + g.path + "') threw an exception: " + A.message)
            }
            return i
          },
          allocate: function (g, A, I) {
            if (FS.isClosed(g)) throw new FS.ErrnoError(8)
            if (A < 0 || I <= 0) throw new FS.ErrnoError(28)
            if (0 == (2097155 & g.flags)) throw new FS.ErrnoError(8)
            if (!FS.isFile(g.node.mode) && !FS.isDir(g.node.mode)) throw new FS.ErrnoError(43)
            if (!g.stream_ops.allocate) throw new FS.ErrnoError(138)
            g.stream_ops.allocate(g, A, I)
          },
          mmap: function (g, A, I, C, e, t) {
            if (0 != (2 & e) && 0 == (2 & t) && 2 != (2097155 & g.flags)) throw new FS.ErrnoError(2)
            if (1 == (2097155 & g.flags)) throw new FS.ErrnoError(2)
            if (!g.stream_ops.mmap) throw new FS.ErrnoError(43)
            return g.stream_ops.mmap(g, A, I, C, e, t)
          },
          msync: function (g, A, I, C, e) {
            return g && g.stream_ops.msync ? g.stream_ops.msync(g, A, I, C, e) : 0
          },
          munmap: function (g) {
            return 0
          },
          ioctl: function (g, A, I) {
            if (!g.stream_ops.ioctl) throw new FS.ErrnoError(59)
            return g.stream_ops.ioctl(g, A, I)
          },
          readFile: function (g, A) {
            if (
              (((A = A || {}).flags = A.flags || 0),
            ...
            return (
              FS.read(C, t, 0, e, 0),
              'utf8' === A.encoding ? (I = UTF8ArrayToString(t, 0)) : 'binary' === A.encoding && (I = t),
              FS.close(C),
              I
            )
          },
          writeFile: function (g, A, I) {
            ;(I = I || {}).flags = I.flags || 577
            var C = FS.open(g, I.flags, I.mode)
            if ('string' == typeof A) {
              var e = new Uint8Array(lengthBytesUTF8(A) + 1),
                t = stringToUTF8Array(A, e, 0, e.length)
              FS.write(C, e, 0, t, void 0, I.canOwn)
            } else {
              if (!ArrayBuffer.isView(A)) throw new Error('Unsupported data type')
              FS.write(C, A, 0, A.byteLength, void 0, I.canOwn)
            }
            FS.close(C)
          },
          cwd: function () {
          ...
          chdir: function (g) {
            var A = FS.lookupPath(g, { follow: !0 })
            if (null === A.node) throw new FS.ErrnoError(44)
            if (!FS.isDir(A.node.mode)) throw new FS.ErrnoError(54)
            var I = FS.nodePermissions(A.node, 'x')
            if (I) throw new FS.ErrnoError(I)
          ...
          createDefaultDevices: function () {
            ...
            var g = getRandomDevice()
            FS.createDevice('/dev', 'random', g),
              FS.createDevice('/dev', 'urandom', g),
              FS.mkdir('/dev/shm'),
              FS.mkdir('/dev/shm/tmp')
          },
          createSpecialDirectories: function () {
            FS.mkdir('/proc')
            var g = FS.mkdir('/proc/self')
            FS.mkdir('/proc/self/fd'),
              FS.mount(
                {
                  mount: function () {
                    var A = FS.createNode(g, 'fd', 16895, 73)
                    return (
                      (A.node_ops = {
                        lookup: function (g, A) {
                          var I = +A,
          ...
          ensureErrnoError: function () {
            FS.ErrnoError ||
              ((FS.ErrnoError = function (g, A) {
                ;(this.node = A),
                  (this.setErrno = function (g) {
                    this.errno = g
                  }),
                  this.setErrno(g),
              ...
              [44].forEach(function (g) {
                ;(FS.genericErrors[g] = new FS.ErrnoError(g)), (FS.genericErrors[g].stack = '<generic error, no stack>')
              }))
          },
          staticInit: function () {
            FS.ensureErrnoError(),
          ...
          init: function (g, A, I) {
            ;(FS.init.initialized = !0),
              FS.ensureErrnoError(),
              (Module.stdin = g || Module.stdin),
              (Module.stdout = A || Module.stdout),
              (Module.stderr = I || Module.stderr),
              FS.createStandardStreams()
          },
          quit: function () {
            FS.init.initialized = !1
            var g = Module._fflush
            g && g(0)
          ...
          getMode: function (g, A) {
            var I = 0
            return g && (I |= 365), A && (I |= 146), I
          },
          findObject: function (g, A) {
            var I = FS.analyzePath(g, A)
            return I.exists ? I.object : null
          },
          analyzePath: function (g, A) {
            try {
              g = (C = FS.lookupPath(g, { follow: !A })).path
            } catch (g) {}
            var I = {
              isRoot: !1,
              exists: !1,
            ...
            try {
              var C = FS.lookupPath(g, { parent: !0 })
              ;(I.parentExists = !0),
                (I.parentPath = C.path),
                (I.parentObject = C.node),
                (I.name = PATH.basename(g)),
                (C = FS.lookupPath(g, { follow: !A })),
                (I.exists = !0),
                (I.path = C.path),
                (I.object = C.node),
                (I.name = C.node.name),
          ...
          createPath: function (g, A, I, C) {
            g = 'string' == typeof g ? g : FS.getPath(g)
            for (var e = A.split('/').reverse(); e.length; ) {
              var t = e.pop()
              if (t) {
                var n = PATH.join2(g, t)
                try {
                  FS.mkdir(n)
                } catch (g) {}
                g = n
          ...
          createFile: function (g, A, I, C, e) {
            var t = PATH.join2('string' == typeof g ? g : FS.getPath(g), A),
              n = FS.getMode(C, e)
            return FS.create(t, n)
          },
          createDataFile: function (g, A, I, C, e, t) {
            var n = A ? PATH.join2('string' == typeof g ? g : FS.getPath(g), A) : g,
              i = FS.getMode(C, e),
              r = FS.create(n, i)
            if (I) {
              if ('string' == typeof I) {
                for (var o = new Array(I.length), a = 0, l = I.length; a < l; ++a) o[a] = I.charCodeAt(a)
                I = o
              }
              FS.chmod(r, 146 | i)
              var c = FS.open(r, 577)
              FS.write(c, I, 0, I.length, 0, t), FS.close(c), FS.chmod(r, i)
            }
            return r
          },
          createDevice: function (g, A, I, C) {
            var e = PATH.join2('string' == typeof g ? g : FS.getPath(g), A),
              t = FS.getMode(!!I, !!C)
            FS.createDevice.major || (FS.createDevice.major = 64)
            var n = FS.makedev(FS.createDevice.major++, 0)
            return (
              FS.registerDevice(n, {
                open: function (g) {
                  g.seekable = !1
                ...
                read: function (g, A, C, e, t) {
                  for (var n = 0, i = 0; i < e; i++) {
                    ...
                    if (void 0 === r && 0 === n) throw new FS.ErrnoError(6)
                    if (null == r) break
                    n++, (A[C + i] = r)
                  }
                  return n && (g.node.timestamp = Date.now()), n
                },
                write: function (g, A, I, e, t) {
                  for (var n = 0; n < e; n++)
                    try {
                      C(A[I + n])
                    } catch (g) {
                  ...
                  return e && (g.node.timestamp = Date.now()), n
                },
              }),
              FS.mkdev(e, t, n)
            )
          },
          forceLoadFile: function (g) {
            if (g.isDevice || g.isFolder || g.link || g.contents) return !0
            ...
            try {
              ;(g.contents = intArrayFromString(read_(g.url), !0)), (g.usedBytes = g.contents.length)
            } catch (g) {
              throw new FS.ErrnoError(29)
            }
          },
          createLazyFile: function (g, A, I, C, e) {
            function t() {
            ...
            if (
              ((t.prototype.get = function (g) {
                if (!(g > this.length - 1 || g < 0)) {
                  var A = g % this.chunkSize,
                    I = (g / this.chunkSize) | 0
                  return this.getter(I)[A]
                }
              }),
              (t.prototype.setDataGetter = function (g) {
                this.getter = g
              }),
              (t.prototype.cacheLength = function () {
                var g = new XMLHttpRequest()
                if ((g.open('HEAD', I, !1), g.send(null), !((g.status >= 200 && g.status < 300) || 304 === g.status)))
                  throw new Error("Couldn't load " + I + '. Status: ' + g.status)
                var A,
                  C = Number(g.getResponseHeader('Content-length')),
                  e = (A = g.getResponseHeader('Accept-Ranges')) && 'bytes' === A,
                  t = (A = g.getResponseHeader('Content-Encoding')) && 'gzip' === A,
                  n = 1048576
                e || (n = C)
                var i = this
                i.setDataGetter(function (g) {
                  var A = g * n,
                    e = (g + 1) * n - 1
                  if (
                    ((e = Math.min(e, C - 1)),
                    void 0 === i.chunks[g] &&
                      (i.chunks[g] = (function (g, A) {
                        if (g > A) throw new Error('invalid range (' + g + ', ' + A + ') or no bytes requested!')
                        if (A > C - 1) throw new Error('only ' + C + ' bytes available! programmer error!')
                        var e = new XMLHttpRequest()
                        if (
                          (e.open('GET', I, !1),
                          C !== n && e.setRequestHeader('Range', 'bytes=' + g + '-' + A),
              ...
              var i = { isDevice: !1, contents: n }
            } else i = { isDevice: !1, url: I }
            var r = FS.createFile(g, A, i, C, e)
            i.contents ? (r.contents = i.contents) : i.url && ((r.contents = null), (r.url = i.url)),
            ...
            var o = {}
            return (
              Object.keys(r.stream_ops).forEach(function (g) {
                var A = r.stream_ops[g]
                o[g] = function () {
                  return FS.forceLoadFile(r), A.apply(null, arguments)
                }
              }),
              (o.read = function (g, A, I, C, e) {
                ...
                var n = Math.min(t.length - e, C)
                if (t.slice) for (var i = 0; i < n; i++) A[I + i] = t[e + i]
                else for (i = 0; i < n; i++) A[I + i] = t.get(e + i)
                return n
              }),
              (r.stream_ops = o),
              r
          ...
          createPreloadedFile: function (g, A, I, C, e, t, n, i, r, o) {
            Browser.init()
            var a = A ? PATH_FS.resolve(PATH.join2(g, A)) : g,
              l = getUniqueRunDependency('cp ' + a)
            function c(I) {
              function c(I) {
                o && o(), i || FS.createDataFile(g, A, I, C, e, r), t && t(), removeRunDependency(l)
              }
              var d = !1
              Module.preloadPlugins.forEach(function (g) {
                d ||
                  (g.canHandle(a) &&
                    (g.handle(I, a, c, function () {
                      n && n(), removeRunDependency(l)
                    }),
                    (d = !0)))
              }),
                d || c(I)
          ...
          saveFilesToDB: function (g, A, I) {
            ;(A = A || function () {}), (I = I || function () {})
            var C = FS.indexedDB()
            try {
              var e = C.open(FS.DB_NAME(), FS.DB_VERSION)
            } catch (g) {
              return I(g)
            }
            ;(e.onupgradeneeded = function () {
              out('creating db'), e.result.createObjectStore(FS.DB_STORE_NAME)
            }),
              (e.onsuccess = function () {
                var C = e.result.transaction([FS.DB_STORE_NAME], 'readwrite'),
                  t = C.objectStore(FS.DB_STORE_NAME),
                  n = 0,
                  i = 0,
                  r = g.length
                function o() {
                ...
                g.forEach(function (g) {
                  var A = t.put(FS.analyzePath(g).object.contents, g)
          ...
          loadFilesFromDB: function (g, A, I) {
            ;(A = A || function () {}), (I = I || function () {})
            var C = FS.indexedDB()
            try {
              var e = C.open(FS.DB_NAME(), FS.DB_VERSION)
            ...
            ;(e.onupgradeneeded = I),
              (e.onsuccess = function () {
                var C = e.result
                try {
                  var t = C.transaction([FS.DB_STORE_NAME], 'readonly')
                } catch (g) {
                  return void I(g)
                }
                ...
                g.forEach(function (g) {
                  var A = n.get(g)
                  ;(A.onsuccess = function () {
                    FS.analyzePath(g).exists && FS.unlink(g),
                      FS.createDataFile(PATH.dirname(g), PATH.basename(g), A.result, !0, !0, !0),
                      ++i + r == o && a()
                  }),
                    (A.onerror = function () {
                      r++, i + r == o && a()
        ...
        SYSCALLS = {
          ...
          DEFAULT_POLLMASK: 5,
          umask: 511,
          calculateAt: function (g, A, I) {
            if ('/' === A[0]) return A
            var C
            if (-100 === g) C = FS.cwd()
            else {
              var e = FS.getStream(g)
            ...
            return PATH.join2(C, A)
          },
          doStat: function (g, A, I) {
            try {
              var C = g(A)
            } catch (g) {
              if (g && g.node && PATH.normalize(A) !== PATH.normalize(FS.getPath(g.node))) return -54
              throw g
            }
            return (
              (HEAP32[I >> 2] = C.dev),
              (HEAP32[(I + 4) >> 2] = 0),
              (HEAP32[(I + 8) >> 2] = C.ino),
              (HEAP32[(I + 12) >> 2] = C.mode),
              (HEAP32[(I + 16) >> 2] = C.nlink),
              (HEAP32[(I + 20) >> 2] = C.uid),
              (HEAP32[(I + 24) >> 2] = C.gid),
              (HEAP32[(I + 28) >> 2] = C.rdev),
              (HEAP32[(I + 32) >> 2] = 0),
              (tempI64 = [
                C.size >>> 0,
                ((tempDouble = C.size),
              ...
              (HEAP32[(I + 40) >> 2] = tempI64[0]),
              (HEAP32[(I + 44) >> 2] = tempI64[1]),
              (HEAP32[(I + 48) >> 2] = 4096),
              (HEAP32[(I + 52) >> 2] = C.blocks),
              (HEAP32[(I + 56) >> 2] = (C.atime.getTime() / 1e3) | 0),
              (HEAP32[(I + 60) >> 2] = 0),
              (HEAP32[(I + 64) >> 2] = (C.mtime.getTime() / 1e3) | 0),
              (HEAP32[(I + 68) >> 2] = 0),
              (HEAP32[(I + 72) >> 2] = (C.ctime.getTime() / 1e3) | 0),
              (HEAP32[(I + 76) >> 2] = 0),
              (tempI64 = [
                C.ino >>> 0,
                ((tempDouble = C.ino),
              ...
              (HEAP32[(I + 80) >> 2] = tempI64[0]),
              (HEAP32[(I + 84) >> 2] = tempI64[1]),
              0
            )
          },
          doMsync: function (g, A, I, C, e) {
            var t = HEAPU8.slice(g, g + I)
            FS.msync(A, t, e, I, C)
          },
          doMkdir: function (g, A) {
            return (
              '/' === (g = PATH.normalize(g))[g.length - 1] && (g = g.substr(0, g.length - 1)), FS.mkdir(g, A, 0), 0
            )
          },
          doMknod: function (g, A, I) {
            switch (61440 & A) {
              case 32768:
              case 8192:
              case 24576:
            ...
            return FS.mknod(g, A, I), 0
          },
          doReadlink: function (g, A, I) {
            if (I <= 0) return -28
            var C = FS.readlink(g),
              e = Math.min(I, lengthBytesUTF8(C)),
              t = HEAP8[A + e]
            return stringToUTF8(C, A, I + 1), (HEAP8[A + e] = t), e
          },
          doAccess: function (g, A) {
            if (-8 & A) return -28
            var I
            if (!(I = FS.lookupPath(g, { follow: !0 }).node)) return -44
            var C = ''
            return 4 & A && (C += 'r'), 2 & A && (C += 'w'), 1 & A && (C += 'x'), C && FS.nodePermissions(I, C) ? -2 : 0
          },
          doDup: function (g, A, I) {
            var C = FS.getStream(I)
            return C && FS.close(C), FS.open(g, A, 0, I, I).fd
          },
          doReadv: function (g, A, I, C) {
            for (var e = 0, t = 0; t < I; t++) {
              var n = HEAP32[(A + 8 * t) >> 2],
                i = HEAP32[(A + (8 * t + 4)) >> 2],
                r = FS.read(g, HEAP8, n, i, C)
              if (r < 0) return -1
              if (((e += r), r < i)) break
            }
            return e
          },
          doWritev: function (g, A, I, C) {
            for (var e = 0, t = 0; t < I; t++) {
              var n = HEAP32[(A + 8 * t) >> 2],
                i = HEAP32[(A + (8 * t + 4)) >> 2],
                r = FS.write(g, HEAP8, n, i, C)
              if (r < 0) return -1
              e += r
            }
            return e
          ...
          getStr: function (g) {
            return UTF8ToString(g)
          },
          getStreamFromFD: function (g) {
            var A = FS.getStream(g)
      ...
      function ___sys_access(g, A) {
        try {
          return (g = SYSCALLS.getStr(g)), SYSCALLS.doAccess(g, A)
        } catch (g) {
          return (void 0 !== FS && g instanceof FS.ErrnoError) || abort(g), -g.errno
        }
      }
      function ___sys_chmod(g, A) {
        try {
          return (g = SYSCALLS.getStr(g)), FS.chmod(g, A), 0
        } catch (g) {
          return (void 0 !== FS && g instanceof FS.ErrnoError) || abort(g), -g.errno
        }
      }
      function ___sys_fchmod(g, A) {
        try {
          return FS.fchmod(g, A), 0
        } catch (g) {
          return (void 0 !== FS && g instanceof FS.ErrnoError) || abort(g), -g.errno
        }
      }
      function ___sys_fcntl64(g, A, I) {
        SYSCALLS.varargs = I
        try {
          var C = SYSCALLS.getStreamFromFD(g)
          switch (A) {
            case 0:
              return (e = SYSCALLS.get()) < 0 ? -28 : FS.open(C.path, C.flags, 0, e).fd
            case 1:
            case 2:
            case 13:
            case 14:
      ...
      function ___sys_fstat64(g, A) {
        try {
          var I = SYSCALLS.getStreamFromFD(g)
          return SYSCALLS.doStat(FS.stat, I.path, A)
        } catch (g) {
          return (void 0 !== FS && g instanceof FS.ErrnoError) || abort(g), -g.errno
        }
      }
      function ___sys_ftruncate64(g, A, I, C) {
        try {
          var e = SYSCALLS.get64(I, C)
          return FS.ftruncate(g, e), 0
        } catch (g) {
          return (void 0 !== FS && g instanceof FS.ErrnoError) || abort(g), -g.errno
        }
      }
      function ___sys_getdents64(g, A, I) {
        try {
          var C = SYSCALLS.getStreamFromFD(g)
          C.getdents || (C.getdents = FS.readdir(C.path))
          for (
            var e = 280, t = 0, n = FS.llseek(C, 0, 1), i = Math.floor(n / e);
            i < C.getdents.length && t + e <= I;
            ...
            if ('.' === a[0]) (r = 1), (o = 4)
              ...
              var l = FS.lookupNode(C.node, a)
              ;(r = l.id), (o = FS.isChrdev(l.mode) ? 2 : FS.isDir(l.mode) ? 4 : FS.isLink(l.mode) ? 10 : 8)
            }
            ;(tempI64 = [
              r >>> 0,
              ((tempDouble = r),
              ...
              (HEAP32[(A + t) >> 2] = tempI64[0]),
              (HEAP32[(A + t + 4) >> 2] = tempI64[1]),
              (tempI64 = [
                ((i + 1) * e) >>> 0,
                ((tempDouble = (i + 1) * e),
                +Math.abs(tempDouble) >= 1
              ...
              (HEAP32[(A + t + 8) >> 2] = tempI64[0]),
              (HEAP32[(A + t + 12) >> 2] = tempI64[1]),
              (HEAP16[(A + t + 16) >> 1] = 280),
              (HEAP8[(A + t + 18) >> 0] = o),
              stringToUTF8(a, A + t + 19, 256),
              (t += e),
              (i += 1)
          }
          return FS.llseek(C, i * e, 0), t
        } catch (g) {
          return (void 0 !== FS && g instanceof FS.ErrnoError) || abort(g), -g.errno
        }
      }
      ...
      function ___sys_ioctl(g, A, I) {
        ...
        try {
          ...
          switch (A) {
            ...
            case 21531:
              e = SYSCALLS.get()
              return FS.ioctl(C, A, e)
            default:
              abort('bad ioctl syscall ' + A)
          }
        } catch (g) {
          return (void 0 !== FS && g instanceof FS.ErrnoError) || abort(g), -g.errno
        }
      }
      function ___sys_mkdir(g, A) {
        try {
          return (g = SYSCALLS.getStr(g)), SYSCALLS.doMkdir(g, A)
        } catch (g) {
          return (void 0 !== FS && g instanceof FS.ErrnoError) || abort(g), -g.errno
        }
      }
      var ___sys_mprotect = function (g, A, I) {
        err('warning: unsupported syscall: __sys_mprotect')
        try {
          return 0
        } catch (g) {
          return (void 0 !== FS && g instanceof FS.ErrnoError) || abort(g), -g.errno
      ...
      function syscallMunmap(g, A) {
        var I = SYSCALLS.mappings[g]
        if (0 === A || !I) return -28
        if (A === I.len) {
          var C = FS.getStream(I.fd)
          C && (2 & I.prot && SYSCALLS.doMsync(g, C, A, I.flags, I.offset), FS.munmap(C)),
            (SYSCALLS.mappings[g] = null),
            I.allocated && _free(I.malloc)
        }
        return 0
      }
      function ___sys_munmap(g, A) {
        try {
          return syscallMunmap(g, A)
        } catch (g) {
          return (void 0 !== FS && g instanceof FS.ErrnoError) || abort(g), -g.errno
        }
      }
      function ___sys_open(g, A, I) {
        SYSCALLS.varargs = I
        try {
          var C = SYSCALLS.getStr(g),
            e = I ? SYSCALLS.get() : 0
          return FS.open(C, A, e).fd
        } catch (g) {
          return (void 0 !== FS && g instanceof FS.ErrnoError) || abort(g), -g.errno
        }
      }
      function ___sys_rename(g, A) {
        try {
          return (g = SYSCALLS.getStr(g)), (A = SYSCALLS.getStr(A)), FS.rename(g, A), 0
        } catch (g) {
          return (void 0 !== FS && g instanceof FS.ErrnoError) || abort(g), -g.errno
        }
      }
      function ___sys_rmdir(g) {
        try {
          return (g = SYSCALLS.getStr(g)), FS.rmdir(g), 0
        } catch (g) {
          return (void 0 !== FS && g instanceof FS.ErrnoError) || abort(g), -g.errno
        }
      }
      function ___sys_stat64(g, A) {
        try {
          return (g = SYSCALLS.getStr(g)), SYSCALLS.doStat(FS.stat, g, A)
        } catch (g) {
          return (void 0 !== FS && g instanceof FS.ErrnoError) || abort(g), -g.errno
        }
      }
      function ___sys_unlink(g) {
        try {
          return (g = SYSCALLS.getStr(g)), FS.unlink(g), 0
        } catch (g) {
          return (void 0 !== FS && g instanceof FS.ErrnoError) || abort(g), -g.errno
        }
      }
      var char_0 = 48,
        char_9 = 57
      function makeLegalFunctionName(g) {
        if (void 0 === g) return '_unknown'
        var A = (g = g.replace(/[^a-zA-Z0-9_]/g, '$')).charCodeAt(0)
        return A >= char_0 && A <= char_9 ? '_' + g : g
      }
      function createNamedFunction(g, A) {
        return (
          (g = makeLegalFunctionName(g)),
          new Function(
            'body',
      ...
      var emval_free_list = [],
        emval_handle_array = [{}, { value: void 0 }, { value: null }, { value: !0 }, { value: !1 }]
      function count_emval_handles() {
        for (var g = 0, A = 5; A < emval_handle_array.length; ++A) void 0 !== emval_handle_array[A] && ++g
        return g
      }
      function get_first_emval() {
        for (var g = 5; g < emval_handle_array.length; ++g)
          if (void 0 !== emval_handle_array[g]) return emval_handle_array[g]
        return null
      }
      function init_emval() {
        ;(Module.count_emval_handles = count_emval_handles), (Module.get_first_emval = get_first_emval)
      }
      function __emval_register(g) {
        switch (g) {
          case void 0:
            return 1
          case null:
          ...
          case !1:
            return 4
          default:
            var A = emval_free_list.length ? emval_free_list.pop() : emval_handle_array.length
            return (emval_handle_array[A] = { refcount: 1, value: g }), A
        }
      }
      function extendError(g, A) {
        var I = createNamedFunction(A, function (g) {
          ;(this.name = A), (this.message = g)
          var I = new Error(g).stack
      ...
      var PureVirtualError = void 0
      function embind_init_charCodes() {
        for (var g = new Array(256), A = 0; A < 256; ++A) g[A] = String.fromCharCode(A)
        embind_charCodes = g
      }
      var embind_charCodes = void 0
      function readLatin1String(g) {
        for (var A = '', I = g; HEAPU8[I]; ) A += embind_charCodes[HEAPU8[I++]]
        return A
      }
      ...
      function getLiveInheritedInstances() {
        var g = []
        for (var A in registeredInstances) registeredInstances.hasOwnProperty(A) && g.push(registeredInstances[A])
        return g
      }
      var deletionQueue = []
      function flushPendingDeletes() {
        for (; deletionQueue.length; ) {
          var g = deletionQueue.pop()
          ;(g.$$.deleteScheduled = !1), g.delete()
        }
      }
      var delayFunction = void 0
      function setDelayFunction(g) {
        ;(delayFunction = g), deletionQueue.length && delayFunction && delayFunction(flushPendingDeletes)
      }
      ...
      var registeredInstances = {},
        BindingError = void 0
      function throwBindingError(g) {
        throw new BindingError(g)
      }
      function getBasestPointer(g, A) {
        for (void 0 === A && throwBindingError('ptr should not be undefined'); g.baseClass; )
          (A = g.upcast(A)), (g = g.baseClass)
        return A
      }
      function registerInheritedInstance(g, A, I) {
        ;(A = getBasestPointer(g, A)),
          registeredInstances.hasOwnProperty(A)
            ? throwBindingError('Tried to register registered instance: ' + A)
            : (registeredInstances[A] = I)
      }
      function requireHandle(g) {
        return g || throwBindingError('Cannot use deleted val. handle = ' + g), emval_handle_array[g].value
      }
      var registeredTypes = {}
      function getTypeName(g) {
        var A = ___getTypeName(g),
          I = readLatin1String(A)
        return _free(A), I
      }
      function requireRegisteredType(g, A) {
        var I = registeredTypes[g]
        return void 0 === I && throwBindingError(A + ' has unknown type ' + getTypeName(g)), I
      }
      function unregisterInheritedInstance(g, A) {
        ;(A = getBasestPointer(g, A)),
          registeredInstances.hasOwnProperty(A)
            ? delete registeredInstances[A]
            : throwBindingError('Tried to unregister unregistered instance: ' + A)
      }
      function detachFinalizer(g) {}
      var finalizationGroup = !1
      function runDestructor(g) {
        g.smartPtr ? g.smartPtrType.rawDestructor(g.smartPtr) : g.ptrType.registeredClass.rawDestructor(g.ptr)
      }
      function releaseClassHandle(g) {
        ;(g.count.value -= 1), 0 === g.count.value && runDestructor(g)
      }
      function attachFinalizer(g) {
        return 'undefined' == typeof FinalizationGroup
          ? ((attachFinalizer = function (g) {
              return g
            }),
            g)
          : ((finalizationGroup = new FinalizationGroup(function (g) {
              for (var A = g.next(); !A.done; A = g.next()) {
                var I = A.value
                I.ptr ? releaseClassHandle(I) : console.warn('object already deleted: ' + I.ptr)
              }
            })),
            (attachFinalizer = function (g) {
              return finalizationGroup.register(g, g.$$, g.$$), g
            }),
            (detachFinalizer = function (g) {
              finalizationGroup.unregister(g.$$)
            }),
            attachFinalizer(g))
      }
      function __embind_create_inheriting_constructor(g, A, I) {
        ;(g = readLatin1String(g)), (A = requireRegisteredType(A, 'wrapper')), (I = requireHandle(I))
        var C = [].slice,
          e = A.registeredClass,
          t = e.instancePrototype,
          n = e.baseClass.instancePrototype,
          i = e.baseClass.constructor,
          r = createNamedFunction(g, function () {
            e.baseClass.pureVirtualFunctions.forEach(
              function (g) {
                if (this[g] === n[g])
                  throw new PureVirtualError('Pure virtual function ' + g + ' must be implemented in JavaScript')
              }.bind(this),
            ),
              Object.defineProperty(this, '__parent', { value: t }),
              this.__construct.apply(this, C.call(arguments))
          })
        for (var o in ((t.__construct = function () {
          this === t && throwBindingError("Pass correct 'this' to __construct")
          var g = i.implement.apply(void 0, [this].concat(C.call(arguments)))
          detachFinalizer(g)
          var A = g.$$
          g.notifyOnDestruction(),
            (A.preservePointerOnDelete = !0),
            Object.defineProperties(this, { $$: { value: A } }),
            attachFinalizer(this),
            registerInheritedInstance(e, A.ptr, this)
        }),
        (t.__destruct = function () {
          this === t && throwBindingError("Pass correct 'this' to __destruct"),
            detachFinalizer(this),
            unregisterInheritedInstance(e, this.$$.ptr)
        }),
      ...
      function runDestructors(g) {
        for (; g.length; ) {
          var A = g.pop()
          g.pop()(A)
        }
      }
      function simpleReadValueFromPointer(g) {
        return this.fromWireType(HEAPU32[g >> 2])
      }
      var awaitingDependencies = {},
        typeDependencies = {},
        InternalError = void 0
      function throwInternalError(g) {
        throw new InternalError(g)
      }
      function whenDependentTypesAreResolved(g, A, I) {
        function C(A) {
          var C = I(A)
          C.length !== g.length && throwInternalError('Mismatched type converter count')
          for (var e = 0; e < g.length; ++e) registerType(g[e], C[e])
        }
        g.forEach(function (g) {
          typeDependencies[g] = A
        })
        var e = new Array(A.length),
          t = [],
          n = 0
        A.forEach(function (g, A) {
          registeredTypes.hasOwnProperty(g)
            ? (e[A] = registeredTypes[g])
            : (t.push(g),
              awaitingDependencies.hasOwnProperty(g) || (awaitingDependencies[g] = []),
              awaitingDependencies[g].push(function () {
                ;(e[A] = registeredTypes[g]), ++n === t.length && C(e)
              }))
        }),
          0 === t.length && C(e)
      }
      function __embind_finalize_value_object(g) {
        var A = structRegistrations[g]
        delete structRegistrations[g]
          ...
          function (g) {
            ...
            return (
              e.forEach(function (A, I) {
                ...
                t[C] = {
                  read: function (g) {
                    return n.fromWireType(i(r, g))
                  },
                  write: function (g, A) {
                    var I = []
                    a(l, g, o.toWireType(I, A)), runDestructors(I)
                  },
                }
              }),
              [
                {
                  ...
                  fromWireType: function (g) {
                    var A = {}
                    for (var I in t) A[I] = t[I].read(g)
                    return C(g), A
                  },
                  toWireType: function (g, A) {
                    for (var e in t) if (!(e in A)) throw new TypeError('Missing field:  "' + e + '"')
                    var n = I()
                    for (e in t) t[e].write(n, A[e])
                    return null !== g && g.push(C, n), n
                  },
                  argPackAdvance: 8,
      ...
      function __embind_register_bigint(g, A, I, C, e) {}
      function getShiftFromSize(g) {
        switch (g) {
          case 1:
            return 0
          case 2:
      ...
      function registerType(g, A, I) {
        if (((I = I || {}), !('argPackAdvance' in A)))
          throw new TypeError('registerType registeredInstance requires argPackAdvance')
        var C = A.name
        if (
          (g || throwBindingError('type "' + C + '" must have a positive integer typeid pointer'),
          registeredTypes.hasOwnProperty(g))
        ) {
          if (I.ignoreDuplicateRegistrations) return
          throwBindingError("Cannot register type '" + C + "' twice")
        }
        if (((registeredTypes[g] = A), delete typeDependencies[g], awaitingDependencies.hasOwnProperty(g))) {
          var e = awaitingDependencies[g]
          delete awaitingDependencies[g],
            e.forEach(function (g) {
              g()
            })
        }
      }
      function __embind_register_bool(g, A, I, C, e) {
        var t = getShiftFromSize(I)
        registerType(g, {
          name: (A = readLatin1String(A)),
          fromWireType: function (g) {
            return !!g
          },
          toWireType: function (g, A) {
          ...
          readValueFromPointer: function (g) {
            var C
            if (1 === I) C = HEAP8
            else if (2 === I) C = HEAP16
            else {
              if (4 !== I) throw new TypeError('Unknown boolean type size: ' + A)
              C = HEAP32
            }
            return this.fromWireType(C[g >> t])
          },
          destructorFunction: null,
        })
      }
      function ClassHandle_isAliasOf(g) {
        if (!(this instanceof ClassHandle)) return !1
        if (!(g instanceof ClassHandle)) return !1
        for (
          var A = this.$$.ptrType.registeredClass, I = this.$$.ptr, C = g.$$.ptrType.registeredClass, e = g.$$.ptr;
          A.baseClass;

        )
          (I = A.upcast(I)), (A = A.baseClass)
        for (; C.baseClass; ) (e = C.upcast(e)), (C = C.baseClass)
        return A === C && I === e
      }
      function shallowCopyInternalPointer(g) {
        return {
          count: g.count,
      ...
      function throwInstanceAlreadyDeleted(g) {
        throwBindingError(g.$$.ptrType.registeredClass.name + ' instance already deleted')
      }
      function ClassHandle_clone() {
        if ((this.$$.ptr || throwInstanceAlreadyDeleted(this), this.$$.preservePointerOnDelete))
          return (this.$$.count.value += 1), this
        var g = attachFinalizer(
      ...
      function ensureOverloadTable(g, A, I) {
        if (void 0 === g[A].overloadTable) {
          var C = g[A]
          ;(g[A] = function () {
            return (
      ...
      function exposePublicSymbol(g, A, I) {
        Module.hasOwnProperty(g)
          ? ((void 0 === I || (void 0 !== Module[g].overloadTable && void 0 !== Module[g].overloadTable[I])) &&
              throwBindingError("Cannot register public name '" + g + "' twice"),
            ensureOverloadTable(Module, g, g),
            Module.hasOwnProperty(I) &&
              throwBindingError(
                'Cannot register multiple overloads of a function with the same number of arguments (' + I + ')!',
              ),
            (Module[g].overloadTable[I] = A))
          : ((Module[g] = A), void 0 !== I && (Module[g].numArguments = I))
      }
      function RegisteredClass(g, A, I, C, e, t, n, i) {
        ;(this.name = g),
          (this.constructor = A),
          (this.instancePrototype = I),
          (this.rawDestructor = C),
          (this.baseClass = e),
          (this.getActualType = t),
          (this.upcast = n),
          (this.downcast = i),
          (this.pureVirtualFunctions = [])
      }
      function upcastPointer(g, A, I) {
        for (; A !== I; )
          A.upcast || throwBindingError('Expected null or instance of ' + I.name + ', got an instance of ' + A.name),
            (g = A.upcast(g)),
            (A = A.baseClass)
        return g
      }
      function constNoSmartPtrRawPointerToWireType(g, A) {
        if (null === A) return this.isReference && throwBindingError('null is not a valid ' + this.name), 0
        ...
        return upcastPointer(A.$$.ptr, I, this.registeredClass)
      }
      function genericPointerToWireType(g, A) {
        var I
        if (null === A)
          return (
            this.isReference && throwBindingError('null is not a valid ' + this.name),
            this.isSmartPointer ? ((I = this.rawConstructor()), null !== g && g.push(this.rawDestructor, I), I) : 0
          )
        A.$$ || throwBindingError('Cannot pass "' + _embind_repr(A) + '" as a ' + this.name),
          A.$$.ptr || throwBindingError('Cannot pass deleted object as a pointer of type ' + this.name),
          !this.isConst &&
        ...
        if (((I = upcastPointer(A.$$.ptr, C, this.registeredClass)), this.isSmartPointer))
          switch (
            (void 0 === A.$$.smartPtr && throwBindingError('Passing raw pointer to smart pointer is illegal'),
            this.sharingPolicy)
          ) {
            case 0:
              A.$$.smartPtrType === this
            ...
            case 2:
              if (A.$$.smartPtrType === this) I = A.$$.smartPtr
                ...
                ;(I = this.rawShare(
                  ...
                  null !== g && g.push(this.rawDestructor, I)
              }
              break
            default:
      ...
      function nonConstNoSmartPtrRawPointerToWireType(g, A) {
        if (null === A) return this.isReference && throwBindingError('null is not a valid ' + this.name), 0
        A.$$ || throwBindingError('Cannot pass "' + _embind_repr(A) + '" as a ' + this.name),
          A.$$.ptr || throwBindingError('Cannot pass deleted object as a pointer of type ' + this.name),
          A.$$.ptrType.isConst &&
      ...
      function RegisteredPointer_getPointee(g) {
        return this.rawGetPointee && (g = this.rawGetPointee(g)), g
      }
      function RegisteredPointer_destructor(g) {
        this.rawDestructor && this.rawDestructor(g)
      }
      function RegisteredPointer_deleteObject(g) {
        null !== g && g.delete()
      }
      function downcastPointer(g, A, I) {
        if (A === I) return g
        if (void 0 === I.baseClass) return null
        var C = downcastPointer(g, A, I.baseClass)
        return null === C ? null : I.downcast(C)
      }
      function getInheritedInstance(g, A) {
        return (A = getBasestPointer(g, A)), registeredInstances[A]
      }
      function makeClassHandle(g, A) {
        return (
          ...
          (A.count = { value: 1 }),
          attachFinalizer(Object.create(g, { $$: { value: A } }))
        )
      }
      function RegisteredPointer_fromWireType(g) {
        var A = this.getPointee(g)
        if (!A) return this.destructor(g), null
        var I = getInheritedInstance(this.registeredClass, A)
        if (void 0 !== I) {
          if (0 === I.$$.count.value) return (I.$$.ptr = A), (I.$$.smartPtr = g), I.clone()
          var C = I.clone()
        ...
        function e() {
          return this.isSmartPointer
            ...
            : makeClassHandle(this.registeredClass.instancePrototype, { ptrType: this, ptr: g })
        }
        var t,
          n = this.registeredClass.getActualType(A),
          i = registeredPointers[n]
        if (!i) return e.call(this)
        t = this.isConst ? i.constPointerType : i.pointerType
        var r = downcastPointer(A, this.registeredClass, t.registeredClass)
        return null === r
          ? e.call(this)
          : this.isSmartPointer
          ...
          : makeClassHandle(t.registeredClass.instancePrototype, { ptrType: t, ptr: r })
      }
      ...
      function RegisteredPointer(g, A, I, C, e, t, n, i, r, o, a) {
        ;(this.name = g),
      ...
      function replacePublicSymbol(g, A, I) {
        Module.hasOwnProperty(g) || throwInternalError('Replacing nonexistant public symbol'),
          void 0 !== Module[g].overloadTable && void 0 !== I
            ? (Module[g].overloadTable[I] = A)
            : ((Module[g] = A), (Module[g].argCount = I))
      }
      function dynCallLegacy(g, A, I) {
        var C = Module['dynCall_' + g]
        return I && I.length ? C.apply(null, [A].concat(I)) : C.call(null, A)
      }
      function dynCall(g, A, I) {
        return g.includes('j') ? dynCallLegacy(g, A, I) : wasmTable.get(A).apply(null, I)
      }
      function getDynCaller(g, A) {
        var I = []
        return function () {
          I.length = arguments.length
          for (var C = 0; C < arguments.length; C++) I[C] = arguments[C]
          return dynCall(g, A, I)
        }
      }
      function embind__requireFunction(g, A) {
        var I = (g = readLatin1String(g)).includes('j') ? getDynCaller(g, A) : wasmTable.get(A)
        return 'function' != typeof I && throwBindingError('unknown function pointer with signature ' + g + ': ' + A), I
      }
      var UnboundTypeError = void 0
      function throwUnboundTypeError(g, A) {
        var I = [],
          C = {}
        throw (
          (A.forEach(function g(A) {
            C[A] ||
              registeredTypes[A] ||
              (typeDependencies[A] ? typeDependencies[A].forEach(g) : (I.push(A), (C[A] = !0)))
          }),
          new UnboundTypeError(g + ': ' + I.map(getTypeName).join([', '])))
        )
      }
      function __embind_register_class(g, A, I, C, e, t, n, i, r, o, a, l, c) {
        ;(a = readLatin1String(a)),
          (t = embind__requireFunction(e, t)),
          i && (i = embind__requireFunction(n, i)),
          o && (o = embind__requireFunction(r, o)),
          (c = embind__requireFunction(l, c))
        var d = makeLegalFunctionName(a)
        exposePublicSymbol(d, function () {
          throwUnboundTypeError('Cannot construct ' + a + ' due to unbound types', [C])
        }),
          whenDependentTypesAreResolved([g, A, I], C ? [C] : [], function (A) {
            var I, e
            ;(A = A[0]), (e = C ? (I = A.registeredClass).instancePrototype : ClassHandle.prototype)
            var n = createNamedFunction(d, function () {
                if (Object.getPrototypeOf(this) !== r) throw new BindingError("Use 'new' to construct " + a)
                if (void 0 === l.constructor_body) throw new BindingError(a + ' has no accessible constructor')
                var g = l.constructor_body[arguments.length]
                if (void 0 === g)
              ...
              r = Object.create(e, { constructor: { value: n } })
            n.prototype = r
            var l = new RegisteredClass(a, n, r, c, I, t, i, o),
              s = new RegisteredPointer(a, l, !0, !1, !1),
              u = new RegisteredPointer(a + '*', l, !1, !1, !1),
              m = new RegisteredPointer(a + ' const*', l, !1, !0, !1)
            return (
              (registeredPointers[g] = { pointerType: u, constPointerType: m }), replacePublicSymbol(d, n), [s, u, m]
            )
          })
      }
      function new_(g, A) {
        ...
        var I = createNamedFunction(g.name || 'unknownFunctionName', function () {})
        I.prototype = g.prototype
        var C = new I(),
          e = g.apply(C, A)
        return e instanceof Object ? e : C
      }
      function craftInvokerFunction(g, A, I, C, e) {
        var t = A.length
        t < 2 && throwBindingError("argTypes array size mismatch! Must at least get return value and 'this' types!")
        for (var n = null !== A[1] && null !== I, i = !1, r = 1; r < A.length; ++r)
          if (null !== A[r] && void 0 === A[r].destructorFunction) {
            i = !0
            break
          }
        var o = 'void' !== A[0].name,
          ...
          l = ''
        for (r = 0; r < t - 2; ++r)
          (a += (0 !== r ? ', ' : '') + 'arg' + r), (l += (0 !== r ? ', ' : '') + 'arg' + r + 'Wired')
        var c =
          'return function ' +
          makeLegalFunctionName(g) +
          '(' +
          a +
          ') {\nif (arguments.length !== ' +
          (t - 2) +
          ...
          " args!');\n}\n"
        i && (c += 'var destructors = [];\n')
        var d = i ? 'destructors' : 'null',
          s = ['throwBindingError', 'invoker', 'fn', 'runDestructors', 'retType', 'classParam'],
          u = [throwBindingError, C, e, runDestructors, A[0], A[1]]
        n && (c += 'var thisWired = classParam.toWireType(' + d + ', this);\n')
        for (r = 0; r < t - 2; ++r)
          (c +=
            'var arg' + r + 'Wired = argType' + r + '.toWireType(' + d + ', arg' + r + '); // ' + A[r + 2].name + '\n'),
            s.push('argType' + r),
            u.push(A[r + 2])
        if (
          (n && (l = 'thisWired' + (l.length > 0 ? ', ' : '') + l),
          (c += (o ? 'var rv = ' : '') + 'invoker(fn' + (l.length > 0 ? ', ' : '') + l + ');\n'),
          i)
        )
          c += 'runDestructors(destructors);\n'
        else
          for (r = n ? 1 : 2; r < A.length; ++r) {
            var m = 1 === r ? 'thisWired' : 'arg' + (r - 2) + 'Wired'
            null !== A[r].destructorFunction &&
              ((c += m + '_dtor(' + m + '); // ' + A[r].name + '\n'),
              s.push(m + '_dtor'),
              u.push(A[r].destructorFunction))
          }
        return (
          o && (c += 'var ret = retType.fromWireType(rv);\nreturn ret;\n'),
          (c += '}\n'),
          s.push(c),
          new_(Function, s).apply(null, u)
        )
      }
      function heap32VectorToArray(g, A) {
        for (var I = [], C = 0; C < g; C++) I.push(HEAP32[(A >> 2) + C])
        return I
      }
      function __embind_register_class_class_function(g, A, I, C, e, t, n) {
        var i = heap32VectorToArray(I, C)
        ;(A = readLatin1String(A)),
          (t = embind__requireFunction(e, t)),
          whenDependentTypesAreResolved([], [g], function (g) {
            var C = (g = g[0]).name + '.' + A
            function e() {
              throwUnboundTypeError('Cannot call ' + C + ' due to unbound types', i)
            }
            A.startsWith('@@') && (A = Symbol[A.substring(2)])
            var r = g.registeredClass.constructor
            return (
              void 0 === r[A]
                ? ((e.argCount = I - 1), (r[A] = e))
                : (ensureOverloadTable(r, A, C), (r[A].overloadTable[I - 1] = e)),
              whenDependentTypesAreResolved([], i, function (g) {
                var e = [g[0], null].concat(g.slice(1)),
                  i = craftInvokerFunction(C, e, null, t, n)
                return (
                  void 0 === r[A].overloadTable ? ((i.argCount = I - 1), (r[A] = i)) : (r[A].overloadTable[I - 1] = i),
                  []
                )
              }),
              []
      ...
      function __embind_register_class_constructor(g, A, I, C, e, t) {
        assert(A > 0)
        var n = heap32VectorToArray(A, I)
        ;(e = embind__requireFunction(C, e)),
          whenDependentTypesAreResolved([], [g], function (g) {
            var I = 'constructor ' + (g = g[0]).name
            if (
              (void 0 === g.registeredClass.constructor_body && (g.registeredClass.constructor_body = []),
              void 0 !== g.registeredClass.constructor_body[A - 1])
            )
              throw new BindingError(
            ...
            return (
              (g.registeredClass.constructor_body[A - 1] = function () {
                throwUnboundTypeError('Cannot construct ' + g.name + ' due to unbound types', n)
              }),
              whenDependentTypesAreResolved([], n, function (C) {
                return (
                  C.splice(1, 0, null),
                  (g.registeredClass.constructor_body[A - 1] = craftInvokerFunction(I, C, null, e, t)),
                  []
                )
              }),
              []
      ...
      function __embind_register_class_function(g, A, I, C, e, t, n, i) {
        var r = heap32VectorToArray(I, C)
        ;(A = readLatin1String(A)),
          (t = embind__requireFunction(e, t)),
          whenDependentTypesAreResolved([], [g], function (g) {
            var C = (g = g[0]).name + '.' + A
            function e() {
              throwUnboundTypeError('Cannot call ' + C + ' due to unbound types', r)
            }
            A.startsWith('@@') && (A = Symbol[A.substring(2)]), i && g.registeredClass.pureVirtualFunctions.push(A)
            var o = g.registeredClass.instancePrototype,
              a = o[A]
            return (
              void 0 === a || (void 0 === a.overloadTable && a.className !== g.name && a.argCount === I - 2)
                ? ((e.argCount = I - 2), (e.className = g.name), (o[A] = e))
                : (ensureOverloadTable(o, A, C), (o[A].overloadTable[I - 2] = e)),
              whenDependentTypesAreResolved([], r, function (e) {
                var i = craftInvokerFunction(C, e, g, t, n)
                return (
                  void 0 === o[A].overloadTable ? ((i.argCount = I - 2), (o[A] = i)) : (o[A].overloadTable[I - 2] = i),
                  []
                )
              }),
              []
      ...
      function __emval_decref(g) {
        g > 4 && 0 == --emval_handle_array[g].refcount && ((emval_handle_array[g] = void 0), emval_free_list.push(g))
      }
      function __embind_register_emval(g, A) {
        registerType(g, {
          name: (A = readLatin1String(A)),
          fromWireType: function (g) {
            var A = emval_handle_array[g].value
            return __emval_decref(g), A
          },
          toWireType: function (g, A) {
      ...
      function _embind_repr(g) {
        if (null === g) return 'null'
        var A = typeof g
        return 'object' === A || 'array' === A || 'function' === A ? g.toString() : '' + g
      }
      function floatReadValueFromPointer(g, A) {
        switch (A) {
          case 2:
            return function (g) {
              return this.fromWireType(HEAPF32[g >> 2])
            }
          case 3:
            return function (g) {
              return this.fromWireType(HEAPF64[g >> 3])
            }
          default:
            throw new TypeError('Unknown float type: ' + g)
        }
      }
      function __embind_register_float(g, A, I) {
        var C = getShiftFromSize(I)
        registerType(g, {
          name: (A = readLatin1String(A)),
          fromWireType: function (g) {
            return g
          ...
          toWireType: function (g, A) {
            if ('number' != typeof A && 'boolean' != typeof A)
              throw new TypeError('Cannot convert "' + _embind_repr(A) + '" to ' + this.name)
            return A
          },
          argPackAdvance: 8,
          readValueFromPointer: floatReadValueFromPointer(A, C),
          destructorFunction: null,
        })
      }
      function __embind_register_function(g, A, I, C, e, t) {
        var n = heap32VectorToArray(A, I)
        ;(g = readLatin1String(g)),
          ...
          exposePublicSymbol(
            g,
            function () {
              throwUnboundTypeError('Cannot call ' + g + ' due to unbound types', n)
            },
            A - 1,
          ),
          whenDependentTypesAreResolved([], n, function (I) {
            var C = [I[0], null].concat(I.slice(1))
            return replacePublicSymbol(g, craftInvokerFunction(g, C, null, e, t), A - 1), []
          })
      }
      function integerReadValueFromPointer(g, A, I) {
        switch (A) {
          case 0:
            return I
              ? function (g) {
      ...
      function __embind_register_integer(g, A, I, C, e) {
        ...
        var r = A.includes('unsigned')
        registerType(g, {
          name: A,
          fromWireType: n,
          toWireType: function (g, I) {
            if ('number' != typeof I && 'boolean' != typeof I)
              throw new TypeError('Cannot convert "' + _embind_repr(I) + '" to ' + this.name)
            if (I < C || I > e)
              throw new TypeError(
                'Passing a number "' +
                  _embind_repr(I) +
          ...
          argPackAdvance: 8,
          readValueFromPointer: integerReadValueFromPointer(A, t, 0 !== C),
          destructorFunction: null,
        })
      }
      function __embind_register_memory_view(g, A, I) {
        var C = [Int8Array, Uint8Array, Int16Array, Uint16Array, Int32Array, Uint32Array, Float32Array, Float64Array][A]
        function e(g) {
          var A = HEAPU32,
            I = A[(g >>= 2)],
            e = A[g + 1]
          return new C(buffer, e, I)
        }
        registerType(
          g,
          { name: (I = readLatin1String(I)), fromWireType: e, argPackAdvance: 8, readValueFromPointer: e },
          { ignoreDuplicateRegistrations: !0 },
        )
      }
      function __embind_register_std_string(g, A) {
        var I = 'std::string' === (A = readLatin1String(A))
        registerType(g, {
          name: A,
          fromWireType: function (g) {
            var A,
              C = HEAPU32[g >> 2]
            if (I)
              for (var e = g + 4, t = 0; t <= C; ++t) {
                var n = g + 4 + t
                if (t == C || 0 == HEAPU8[n]) {
                  var i = UTF8ToString(e, n - e)
                  void 0 === A ? (A = i) : ((A += String.fromCharCode(0)), (A += i)), (e = n + 1)
                }
              }
            else {
              var r = new Array(C)
              for (t = 0; t < C; ++t) r[t] = String.fromCharCode(HEAPU8[g + 4 + t])
              A = r.join('')
            }
            return _free(g), A
          },
          toWireType: function (g, A) {
            ...
            var e = (
              ...
              t = _malloc(4 + e + 1)
            if (((HEAPU32[t >> 2] = e), I && C)) stringToUTF8(A, t + 4, e + 1)
            else if (C)
              for (var n = 0; n < e; ++n) {
                var i = A.charCodeAt(n)
                i > 255 && (_free(t), throwBindingError('String has UTF-16 code units that do not fit in 8 bits')),
                  (HEAPU8[t + 4 + n] = i)
              }
            else for (n = 0; n < e; ++n) HEAPU8[t + 4 + n] = A[n]
            return null !== g && g.push(_free, t), t
          },
          argPackAdvance: 8,
          readValueFromPointer: simpleReadValueFromPointer,
      ...
      function __embind_register_std_wstring(g, A, I) {
        var C, e, t, n, i
        ;(I = readLatin1String(I)),
          ...
          registerType(g, {
            name: I,
            fromWireType: function (g) {
              for (var I, e = HEAPU32[g >> 2], n = t(), r = g + 4, o = 0; o <= e; ++o) {
                var a = g + 4 + o * A
                if (o == e || 0 == n[a >> i]) {
                  var l = C(r, a - r)
                  void 0 === I ? (I = l) : ((I += String.fromCharCode(0)), (I += l)), (r = a + A)
                }
              }
              return _free(g), I
            },
            toWireType: function (g, C) {
              'string' != typeof C && throwBindingError('Cannot pass non-string to C++ string type ' + I)
              var t = n(C),
                r = _malloc(4 + t + A)
              return (HEAPU32[r >> 2] = t >> i), e(C, r + 4, t + A), null !== g && g.push(_free, r), r
            },
            argPackAdvance: 8,
            readValueFromPointer: simpleReadValueFromPointer,
            destructorFunction: function (g) {
      ...
      function __embind_register_value_object(g, A, I, C, e, t) {
        structRegistrations[g] = {
          name: readLatin1String(A),
          rawConstructor: embind__requireFunction(I, C),
          rawDestructor: embind__requireFunction(e, t),
          fields: [],
        }
      }
      function __embind_register_value_object_field(g, A, I, C, e, t, n, i, r, o) {
        structRegistrations[g].fields.push({
          fieldName: readLatin1String(A),
          getterReturnType: I,
          getter: embind__requireFunction(C, e),
          getterContext: t,
          setterArgumentType: n,
          setter: embind__requireFunction(i, r),
          setterContext: o,
        })
      }
      function __embind_register_void(g, A) {
        registerType(g, {
          isVoid: !0,
          name: (A = readLatin1String(A)),
          argPackAdvance: 0,
      ...
      function __emval_as(g, A, I) {
        ;(g = requireHandle(g)), (A = requireRegisteredType(A, 'emval::as'))
        var C = [],
          e = __emval_register(C)
        return (HEAP32[I >> 2] = e), A.toWireType(C, g)
      }
      function __emval_allocateDestructors(g) {
        var A = []
        return (HEAP32[g >> 2] = __emval_register(A)), A
      }
      var emval_symbols = {}
      function getStringOrSymbol(g) {
        var A = emval_symbols[g]
        return void 0 === A ? readLatin1String(g) : A
      }
      var emval_methodCallers = [],
        _emscripten_get_now
      function __emval_call_method(g, A, I, C, e) {
        return (g = emval_methodCallers[g])(
          (A = requireHandle(A)),
          (I = getStringOrSymbol(I)),
          __emval_allocateDestructors(C),
          e,
        )
      }
      function __emval_call_void_method(g, A, I, C) {
        ;(g = emval_methodCallers[g])((A = requireHandle(A)), (I = getStringOrSymbol(I)), null, C)
      }
      function emval_get_global() {
        return 'object' == typeof globalThis ? globalThis : Function('return this')()
      }
      function __emval_get_global(g) {
        return 0 === g
          ? __emval_register(emval_get_global())
          : ((g = getStringOrSymbol(g)), __emval_register(emval_get_global()[g]))
      }
      function __emval_addMethodCaller(g) {
        var A = emval_methodCallers.length
        return emval_methodCallers.push(g), A
      }
      function __emval_lookupTypes(g, A) {
        for (var I = new Array(g), C = 0; C < g; ++C)
          I[C] = requireRegisteredType(HEAP32[(A >> 2) + C], 'parameter ' + C)
        return I
      }
      function __emval_get_method_caller(g, A) {
        for (
          var I = __emval_lookupTypes(g, A),
            C = I[0],
            e =
              C.name +
              '_$' +
          ...
          (i += (0 !== r ? ', ' : '') + 'arg' + r), t.push('argType' + r), n.push(I[1 + r])
        var o =
            'return function ' + makeLegalFunctionName('methodCaller_' + e) + '(handle, name, destructors, args) {\n',
          a = 0
        for (r = 0; r < g - 1; ++r)
          (o += '    var arg' + r + ' = argType' + r + '.readValueFromPointer(args' + (a ? '+' + a : '') + ');\n'),
            (a += I[r + 1].argPackAdvance)
        o += '    var rv = handle[name](' + i + ');\n'
        for (r = 0; r < g - 1; ++r) I[r + 1].deleteObject && (o += '    argType' + r + '.deleteObject(arg' + r + ');\n')
        return (
          C.isVoid || (o += '    return retType.toWireType(destructors, rv);\n'),
          (o += '};\n'),
          t.push(o),
          __emval_addMethodCaller(new_(Function, t).apply(null, n))
        )
      }
      function __emval_get_property(g, A) {
        return __emval_register((g = requireHandle(g))[(A = requireHandle(A))])
      }
      function __emval_incref(g) {
        g > 4 && (emval_handle_array[g].refcount += 1)
      }
      function __emval_new_cstring(g) {
        return __emval_register(getStringOrSymbol(g))
      }
      function __emval_run_destructors(g) {
        runDestructors(emval_handle_array[g].value), __emval_decref(g)
      }
      function __emval_take_value(g, A) {
        return __emval_register((g = requireRegisteredType(g, '_emval_take_value')).readValueFromPointer(A))
      }
      function __emval_typeof(g) {
        return __emval_register(typeof (g = requireHandle(g)))
      }
      function _abort() {
        abort()
      }
      _emscripten_get_now = ENVIRONMENT_IS_NODE
        ? function () {
            ...
            return 1e3 * g[0] + g[1] / 1e6
          }
        : function () {
            return performance.now()
          }
      var _emscripten_get_now_is_monotonic = !0
      function _clock_gettime(g, A) {
        var I
        if (0 === g) I = Date.now()
        else {
          if ((1 !== g && 4 !== g) || !_emscripten_get_now_is_monotonic) return setErrNo(28), -1
          I = _emscripten_get_now()
        }
        return (HEAP32[A >> 2] = (I / 1e3) | 0), (HEAP32[(A + 4) >> 2] = ((I % 1e3) * 1e3 * 1e3) | 0), 0
      }
      function _difftime(g, A) {
        return g - A
      }
      function _dlclose(g) {
        abort(
      ...
      function readAsmConstArgs(g, A) {
        var I
        for (readAsmConstArgsArray.length = 0, A >>= 2; (I = HEAPU8[g++]); ) {
          var C = I < 105
          C && 1 & A && A++, readAsmConstArgsArray.push(C ? HEAPF64[A++ >> 1] : HEAP32[A]), ++A
        }
        return readAsmConstArgsArray
      }
      function _emscripten_asm_const_int(g, A, I) {
        var C = readAsmConstArgs(A, I)
        return ASM_CONSTS[g].apply(null, C)
      }
      function _emscripten_asm_const_double(g, A, I) {
        return _emscripten_asm_const_int(g, A, I)
      }
      function _emscripten_memcpy_big(g, A, I) {
        HEAPU8.copyWithin(g, A, A + I)
      }
      function emscripten_realloc_buffer(g) {
        try {
          return (
            wasmMemory.grow((g - buffer.byteLength + 65535) >>> 16), updateGlobalBufferAndViews(wasmMemory.buffer), 1
          )
        } catch (g) {}
      }
      function _emscripten_resize_heap(g) {
        var A = HEAPU8.length,
          I = 2147483648
        if ((g >>>= 0) > I) return !1
        for (var C = 1; C <= 4; C *= 2) {
          var e = A * (1 + 0.2 / C)
          if (
            ((e = Math.min(e, g + 100663296)), emscripten_realloc_buffer(Math.min(I, alignUp(Math.max(g, e), 65536))))
          )
            return !0
        }
        return !1
      ...
      function getEnvStrings() {
        if (!getEnvStrings.strings) {
          ...
          for (var A in ENV) void 0 === ENV[A] ? delete g[A] : (g[A] = ENV[A])
          var I = []
          for (var A in g) I.push(A + '=' + g[A])
          getEnvStrings.strings = I
        }
        return getEnvStrings.strings
      }
      function _environ_get(g, A) {
        var I = 0
        return (
          getEnvStrings().forEach(function (C, e) {
            var t = A + I
            ;(HEAP32[(g + 4 * e) >> 2] = t), writeAsciiToMemory(C, t), (I += C.length + 1)
          }),
          0
        )
      }
      function _environ_sizes_get(g, A) {
        var I = getEnvStrings()
        HEAP32[g >> 2] = I.length
        var C = 0
        return (
      ...
      function _fd_close(g) {
        try {
          var A = SYSCALLS.getStreamFromFD(g)
          return FS.close(A), 0
        } catch (g) {
          return (void 0 !== FS && g instanceof FS.ErrnoError) || abort(g), g.errno
        }
      }
      function _fd_fdstat_get(g, A) {
        try {
          var I = SYSCALLS.getStreamFromFD(g),
            C = I.tty ? 2 : FS.isDir(I.mode) ? 3 : FS.isLink(I.mode) ? 7 : 4
          return (HEAP8[A >> 0] = C), 0
        } catch (g) {
          return (void 0 !== FS && g instanceof FS.ErrnoError) || abort(g), g.errno
        }
      }
      function _fd_read(g, A, I, C) {
        try {
          var e = SYSCALLS.getStreamFromFD(g),
            t = SYSCALLS.doReadv(e, A, I)
          return (HEAP32[C >> 2] = t), 0
        } catch (g) {
          return (void 0 !== FS && g instanceof FS.ErrnoError) || abort(g), g.errno
        }
      }
      function _fd_seek(g, A, I, C, e) {
        try {
          var t = SYSCALLS.getStreamFromFD(g),
            n = 4294967296 * I + (A >>> 0),
            i = 9007199254740992
          return n <= -i || n >= i
            ? -61
            : (FS.llseek(t, n, C),
              ...
              t.getdents && 0 === n && 0 === C && (t.getdents = null),
              0)
        } catch (g) {
          return (void 0 !== FS && g instanceof FS.ErrnoError) || abort(g), g.errno
        }
      ...
      function _fd_write(g, A, I, C) {
        try {
          var e = SYSCALLS.getStreamFromFD(g),
            t = SYSCALLS.doWritev(e, A, I)
          return (HEAP32[C >> 2] = t), 0
        } catch (g) {
          return (void 0 !== FS && g instanceof FS.ErrnoError) || abort(g), g.errno
        }
      ...
      function _getentropy(g, A) {
        _getentropy.randomDevice || (_getentropy.randomDevice = getRandomDevice())
        for (var I = 0; I < A; I++) HEAP8[(g + I) >> 0] = _getentropy.randomDevice()
        return 0
      }
      function _gettimeofday(g) {
        var A = Date.now()
        return (HEAP32[g >> 2] = (A / 1e3) | 0), (HEAP32[(g + 4) >> 2] = ((A % 1e3) * 1e3) | 0), 0
      }
      function _llvm_eh_typeid_for(g) {
        return g
      }
      function _setTempRet0(g) {
        setTempRet0(g)
      }
      function __isLeapYear(g) {
        return g % 4 == 0 && (g % 100 != 0 || g % 400 == 0)
      }
      function __arraySum(g, A) {
        for (var I = 0, C = 0; C <= A; I += g[C++]);
        return I
      }
      var __MONTH_DAYS_LEAP = [31, 29, 31, 30, 31, 30, 31, 31, 30, 31, 30, 31],
        __MONTH_DAYS_REGULAR = [31, 28, 31, 30, 31, 30, 31, 31, 30, 31, 30, 31]
      function __addDays(g, A) {
        for (var I = new Date(g.getTime()); A > 0; ) {
          var C = __isLeapYear(I.getFullYear()),
            e = I.getMonth(),
            t = (C ? __MONTH_DAYS_LEAP : __MONTH_DAYS_REGULAR)[e]
          if (!(A > t - I.getDate())) return I.setDate(I.getDate() + A), I
          ;(A -= t - I.getDate() + 1),
            I.setDate(1),
            e < 11 ? I.setMonth(e + 1) : (I.setMonth(0), I.setFullYear(I.getFullYear() + 1))
        }
        return I
      }
      function _strftime(g, A, I, C) {
        var e = HEAP32[(C + 40) >> 2],
          t = {
            tm_sec: HEAP32[C >> 2],
            tm_min: HEAP32[(C + 4) >> 2],
            tm_hour: HEAP32[(C + 8) >> 2],
            tm_mday: HEAP32[(C + 12) >> 2],
            tm_mon: HEAP32[(C + 16) >> 2],
            tm_year: HEAP32[(C + 20) >> 2],
            tm_wday: HEAP32[(C + 24) >> 2],
            tm_yday: HEAP32[(C + 28) >> 2],
            tm_isdst: HEAP32[(C + 32) >> 2],
            tm_gmtoff: HEAP32[(C + 36) >> 2],
            tm_zone: e ? UTF8ToString(e) : '',
          },
          n = UTF8ToString(I),
          i = {
            '%c': '%a %b %d %H:%M:%S %Y',
        ...
        for (var r in i) n = n.replace(new RegExp(r, 'g'), i[r])
        ...
        function l(g, A, I) {
          for (var C = 'number' == typeof g ? g.toString() : g || ''; C.length < A; ) C = I[0] + C
          return C
        }
        function c(g, A) {
          return l(g, A, '0')
        ...
        function d(g, A) {
          ...
          var C
          return (
            0 === (C = I(g.getFullYear() - A.getFullYear())) &&
              0 === (C = I(g.getMonth() - A.getMonth())) &&
              (C = I(g.getDate() - A.getDate())),
            C
          )
        }
        function s(g) {
        ...
        function u(g) {
          var A = __addDays(new Date(g.tm_year + 1900, 0, 1), g.tm_yday),
            I = new Date(A.getFullYear(), 0, 4),
            C = new Date(A.getFullYear() + 1, 0, 4),
            e = s(I),
            t = s(C)
          return d(e, A) <= 0 ? (d(t, A) <= 0 ? A.getFullYear() + 1 : A.getFullYear()) : A.getFullYear() - 1
        }
        var m = {
          '%a': function (g) {
            return o[g.tm_wday].substring(0, 3)
          },
          '%A': function (g) {
            return o[g.tm_wday]
          },
          '%b': function (g) {
            return a[g.tm_mon].substring(0, 3)
          },
          '%B': function (g) {
            return a[g.tm_mon]
          },
          '%C': function (g) {
            return c(((g.tm_year + 1900) / 100) | 0, 2)
          },
          '%d': function (g) {
            return c(g.tm_mday, 2)
          },
          '%e': function (g) {
            return l(g.tm_mday, 2, ' ')
          },
          '%g': function (g) {
            return u(g).toString().substring(2)
          },
          '%G': function (g) {
            return u(g)
          },
          '%H': function (g) {
            return c(g.tm_hour, 2)
          },
          '%I': function (g) {
            var A = g.tm_hour
            return 0 == A ? (A = 12) : A > 12 && (A -= 12), c(A, 2)
          },
          '%j': function (g) {
            return c(
              g.tm_mday +
                __arraySum(__isLeapYear(g.tm_year + 1900) ? __MONTH_DAYS_LEAP : __MONTH_DAYS_REGULAR, g.tm_mon - 1),
              3,
            )
          },
          '%m': function (g) {
            return c(g.tm_mon + 1, 2)
          },
          '%M': function (g) {
            return c(g.tm_min, 2)
          },
          ...
          '%U': function (g) {
            var A = new Date(g.tm_year + 1900, 0, 1),
              I = 0 === A.getDay() ? A : __addDays(A, 7 - A.getDay()),
              C = new Date(g.tm_year + 1900, g.tm_mon, g.tm_mday)
            if (d(I, C) < 0) {
              var e =
                  __arraySum(
                    __isLeapYear(C.getFullYear()) ? __MONTH_DAYS_LEAP : __MONTH_DAYS_REGULAR,
                    C.getMonth() - 1,
                  ) - 31,
                t = 31 - I.getDate() + e + C.getDate()
              return c(Math.ceil(t / 7), 2)
            }
            return 0 === d(I, A) ? '01' : '00'
          },
          '%V': function (g) {
            var A,
              I = new Date(g.tm_year + 1900, 0, 4),
              C = new Date(g.tm_year + 1901, 0, 4),
              e = s(I),
              t = s(C),
              n = __addDays(new Date(g.tm_year + 1900, 0, 1), g.tm_yday)
            return d(n, e) < 0
              ? '53'
              : d(t, n) <= 0
              ? '01'
              : ((A = e.getFullYear() < g.tm_year + 1900 ? g.tm_yday + 32 - e.getDate() : g.tm_yday + 1 - e.getDate()),
                c(Math.ceil(A / 7), 2))
          },
          '%w': function (g) {
            return g.tm_wday
          ...
          '%W': function (g) {
            var A = new Date(g.tm_year, 0, 1),
              I = 1 === A.getDay() ? A : __addDays(A, 0 === A.getDay() ? 1 : 7 - A.getDay() + 1),
              C = new Date(g.tm_year + 1900, g.tm_mon, g.tm_mday)
            if (d(I, C) < 0) {
              var e =
                  __arraySum(
          ...
          '%z': function (g) {
            var A = g.tm_gmtoff,
              I = A >= 0
            return (A = ((A = Math.abs(A) / 60) / 60) * 100 + (A % 60)), (I ? '+' : '-') + String('0000' + A).slice(-4)
          },
          '%Z': function (g) {
            return g.tm_zone
          },
        ...
        for (var r in m) n.includes(r) && (n = n.replace(new RegExp(r, 'g'), m[r](t)))
        var v = intArrayFromString(n, !1)
        return v.length > A ? 0 : (writeArrayToMemory(v, g), v.length - 1)
      }
      function jstoi_q(g) {
        return parseInt(g)
      }
      function _strptime(g, A, I) {
        for (var C = UTF8ToString(A), e = '\\!@#$^&*()+=-[]/{}|:<>?,.', t = 0, n = e.length; t < n; ++t)
          C = C.replace(new RegExp('\\' + e[t], 'g'), '\\' + e[t])
        var i = {
          '%A': '%a',
          '%B': '%b',
          '%c': '%a %b %d %H:%M:%S %Y',
        ...
        for (var r in i) C = C.replace(r, i[r])
        var o = {
        ...
        for (var a in o) C = C.replace(a, '(' + a + o[a] + ')')
        var l = []
        for (t = C.indexOf('%'); t >= 0; t = C.indexOf('%'))
          l.push(C[t + 1]), (C = C.replace(new RegExp('\\%' + C[t + 1], 'g'), ''))
        var c = new RegExp('^' + C, 'i').exec(UTF8ToString(g))
        if (c) {
          var d,
            s = (function () {
              function g(g, A, I) {
                return 'number' != typeof g || isNaN(g) ? A : g >= A ? (g <= I ? g : I) : A
              }
              return {
                year: g(HEAP32[(I + 20) >> 2] + 1900, 1970, 9999),
                month: g(HEAP32[(I + 16) >> 2], 0, 11),
                day: g(HEAP32[(I + 12) >> 2], 1, 31),
                hour: g(HEAP32[(I + 8) >> 2], 0, 23),
                min: g(HEAP32[(I + 4) >> 2], 0, 59),
                sec: g(HEAP32[I >> 2], 0, 59),
              }
            })(),
            u = function (g) {
              var A = l.indexOf(g)
          ...
          if (((d = u('S')) && (s.sec = jstoi_q(d)), (d = u('M')) && (s.min = jstoi_q(d)), (d = u('H'))))
            s.hour = jstoi_q(d)
          else if ((d = u('I'))) {
            var m = jstoi_q(d)
            ;(d = u('p')) && (m += 'P' === d.toUpperCase()[0] ? 12 : 0), (s.hour = m)
          }
          if ((d = u('Y'))) s.year = jstoi_q(d)
          else if ((d = u('y'))) {
            var v = jstoi_q(d)
            ;(d = u('C')) ? (v += 100 * jstoi_q(d)) : (v += v < 69 ? 2e3 : 1900), (s.year = v)
          }
          if (
            ((d = u('m'))
              ? (s.month = jstoi_q(d) - 1)
            ...
            for (var b = jstoi_q(d), Z = __isLeapYear(s.year), p = 0; p < 12; ++p) {
              var h = __arraySum(Z ? __MONTH_DAYS_LEAP : __MONTH_DAYS_REGULAR, p - 1)
              b <= h + (Z ? __MONTH_DAYS_LEAP : __MONTH_DAYS_REGULAR)[p] && (s.day = b - h)
            }
          else if ((d = u('a'))) {
            var R = d.substring(0, 3).toUpperCase()
            if ((d = u('U'))) {
              var y = { SUN: 0, MON: 1, TUE: 2, WED: 3, THU: 4, FRI: 5, SAT: 6 }[R],
                w = jstoi_q(d)
              ;(D =
                0 === (M = new Date(s.year, 0, 1)).getDay()
                  ? __addDays(M, y + 7 * (w - 1))
                  : __addDays(M, 7 - M.getDay() + y + 7 * (w - 1))),
                (s.day = D.getDate()),
                (s.month = D.getMonth())
            } else if ((d = u('W'))) {
              var M, D
              ;(y = { MON: 0, TUE: 1, WED: 2, THU: 3, FRI: 4, SAT: 5, SUN: 6 }[R]), (w = jstoi_q(d))
              ;(D =
                1 === (M = new Date(s.year, 0, 1)).getDay()
                  ? __addDays(M, y + 7 * (w - 1))
                  : __addDays(M, 7 - M.getDay() + 1 + y + 7 * (w - 1))),
                (s.day = D.getDate()),
                (s.month = D.getMonth())
            }
          }
          var S = new Date(s.year, s.month, s.day, s.hour, s.min, s.sec, 0)
          return (
            (HEAP32[I >> 2] = S.getSeconds()),
            (HEAP32[(I + 4) >> 2] = S.getMinutes()),
            (HEAP32[(I + 8) >> 2] = S.getHours()),
            (HEAP32[(I + 12) >> 2] = S.getDate()),
            (HEAP32[(I + 16) >> 2] = S.getMonth()),
            (HEAP32[(I + 20) >> 2] = S.getFullYear() - 1900),
            (HEAP32[(I + 24) >> 2] = S.getDay()),
            (HEAP32[(I + 28) >> 2] =
              __arraySum(__isLeapYear(S.getFullYear()) ? __MONTH_DAYS_LEAP : __MONTH_DAYS_REGULAR, S.getMonth() - 1) +
              S.getDate() -
              1),
            (HEAP32[(I + 32) >> 2] = 0),
            g + intArrayFromString(c[0]).length - 1
          )
        }
        return 0
      }
      function _time(g) {
        var A = (Date.now() / 1e3) | 0
        return g && (HEAP32[g >> 2] = A), A
      }
      function _timegm(g) {
        _tzset()
        var A = Date.UTC(
          ...
          I = new Date(A)
        HEAP32[(g + 24) >> 2] = I.getUTCDay()
        var C = Date.UTC(I.getUTCFullYear(), 0, 1, 0, 0, 0, 0),
          e = ((I.getTime() - C) / 864e5) | 0
        return (HEAP32[(g + 28) >> 2] = e), (I.getTime() / 1e3) | 0
      }
      var FSNode = function (g, A, I, C) {
          g || (g = this),
            (this.parent = g),
            (this.mount = g.mount),
            (this.mounted = null),
        ...
        readMode = 365,
        writeMode = 146
      function intArrayFromString(g, A, I) {
        var C = I > 0 ? I : lengthBytesUTF8(g) + 1,
          e = new Array(C),
          t = stringToUTF8Array(g, e, 0, e.length)
        return A && (e.length = t), e
      }
      Object.defineProperties(FSNode.prototype, {
        read: {
          ...
          set: function (g) {
            g ? (this.mode |= readMode) : (this.mode &= ~readMode)
          },
        },
        write: {
          get: function () {
          ...
          set: function (g) {
            g ? (this.mode |= writeMode) : (this.mode &= ~writeMode)
          },
        },
        isFolder: {
          get: function () {
      ...
      var decodeBase64 =
          'function' == typeof atob
            ...
            : function (g) {
                ...
                do {
                  ;(A = (i.indexOf(g.charAt(o++)) << 2) | ((e = i.indexOf(g.charAt(o++))) >> 4)),
                    (I = ((15 & e) << 4) | ((t = i.indexOf(g.charAt(o++))) >> 2)),
                    (C = ((3 & t) << 6) | (n = i.indexOf(g.charAt(o++)))),
                    (r += String.fromCharCode(A)),
                    64 !== t && (r += String.fromCharCode(I)),
                    64 !== n && (r += String.fromCharCode(C))
                } while (o < g.length)
                return r
              },
        asmLibraryArg = {
          ...
          Ja: ___sys_stat64,
          Na: ___sys_unlink,
          Rb: __embind_create_inheriting_constructor,
          Qc: __embind_finalize_value_object,
          vc: __embind_register_bigint,
          Bb: __embind_register_bool,
          na: __embind_register_class,
          Za: __embind_register_class_class_function,
          Hb: __embind_register_class_constructor,
          ...
          Sc: __embind_register_value_object,
          _a: __embind_register_value_object_field,
          Cb: __embind_register_void,
          db: __emscripten_throw_longjmp,
          fa: __emval_as,
          Y: __emval_call_method,
          Xa: __emval_call_void_method,
          tb: __emval_decref,
          Mb: __emval_get_global,
          U: __emval_get_method_caller,
          Ob: __emval_get_property,
          Oa: __emval_incref,
          Nb: __emval_new_cstring,
          ...
          Lb: _dlopen,
          Jb: _dlsym,
          Qb: _emscripten_asm_const_double,
          ...
          Da: invoke_viff,
          _: invoke_viffff,
          Ec: invoke_viffffffff,
          Oc: invoke_vifi,
          Fa: invoke_vifii,
          ha: invoke_vifiiiiiiif,
          d: invoke_vii,
          aa: invoke_viid,
          P: invoke_viif,
          Ic: invoke_viifi,
          ...
          Uc: invoke_viiiifiii,
          o: invoke_viiiii,
          Lc: invoke_viiiiifiiiii,
          m: invoke_viiiiii,
          Ga: invoke_viiiiiif,
          Gc: invoke_viiiiiiffff,
          A: invoke_viiiiiii,
          bb: invoke_viiiiiiifiii,
          D: invoke_viiiiiiii,
          F: invoke_viiiiiiiii,
          K: invoke_viiiiiiiiii,
          ka: invoke_viiiiiiiiiii,
          W: invoke_viiiiiiiiiiii,
          Ac: invoke_viiiiiiiiiiiii,
          ca: invoke_viiiiiiiiiiiiii,
          qa: invoke_viiiiiiiiiiiiiii,
          _b: invoke_viiiiiijji,
          kc: invoke_viiiijii,
          cc: invoke_viiiijj,
          bc: invoke_viiij,
          Vb: invoke_viiiji,
        ...
        ___wasm_call_ctors = (Module.___wasm_call_ctors = function () {
          return (___wasm_call_ctors = Module.___wasm_call_ctors = Module.asm.Wc).apply(null, arguments)
        }),
        ...
        ___errno_location = (Module.___errno_location = function () {
          return (___errno_location = Module.___errno_location = Module.asm.Yc).apply(null, arguments)
        }),
        _free = (Module._free = function () {
          return (_free = Module._free = Module.asm.Zc).apply(null, arguments)
        }),
        ___getTypeName = (Module.___getTypeName = function () {
          return (___getTypeName = Module.___getTypeName = Module.asm._c).apply(null, arguments)
        }),
        ___embind_register_native_and_builtin_types = (Module.___embind_register_native_and_builtin_types =
          function () {
        ...
        __get_tzname = (Module.__get_tzname = function () {
          return (__get_tzname = Module.__get_tzname = Module.asm.ad).apply(null, arguments)
        }),
        __get_daylight = (Module.__get_daylight = function () {
          return (__get_daylight = Module.__get_daylight = Module.asm.bd).apply(null, arguments)
        }),
        __get_timezone = (Module.__get_timezone = function () {
          return (__get_timezone = Module.__get_timezone = Module.asm.cd).apply(null, arguments)
        }),
        stackSave = (Module.stackSave = function () {
          return (stackSave = Module.stackSave = Module.asm.dd).apply(null, arguments)
        }),
        stackRestore = (Module.stackRestore = function () {
          return (stackRestore = Module.stackRestore = Module.asm.ed).apply(null, arguments)
        }),
        _setThrew = (Module._setThrew = function () {
          return (_setThrew = Module._setThrew = Module.asm.fd).apply(null, arguments)
        }),
        ___cxa_can_catch = (Module.___cxa_can_catch = function () {
          return (___cxa_can_catch = Module.___cxa_can_catch = Module.asm.gd).apply(null, arguments)
        }),
        ___cxa_is_pointer_type = (Module.___cxa_is_pointer_type = function () {
          return (___cxa_is_pointer_type = Module.___cxa_is_pointer_type = Module.asm.hd).apply(null, arguments)
        }),
        _memalign = (Module._memalign = function () {
          return (_memalign = Module._memalign = Module.asm.id).apply(null, arguments)
        }),
        dynCall_viijj = (Module.dynCall_viijj = function () {
          return (dynCall_viijj = Module.dynCall_viijj = Module.asm.kd).apply(null, arguments)
        }),
        dynCall_vij = (Module.dynCall_vij = function () {
          return (dynCall_vij = Module.dynCall_vij = Module.asm.ld).apply(null, arguments)
        }),
        dynCall_ji = (Module.dynCall_ji = function () {
          return (dynCall_ji = Module.dynCall_ji = Module.asm.md).apply(null, arguments)
        }),
        dynCall_iiij = (Module.dynCall_iiij = function () {
          return (dynCall_iiij = Module.dynCall_iiij = Module.asm.nd).apply(null, arguments)
        }),
        dynCall_iij = (Module.dynCall_iij = function () {
          return (dynCall_iij = Module.dynCall_iij = Module.asm.od).apply(null, arguments)
        }),
        dynCall_iiiiji = (Module.dynCall_iiiiji = function () {
          return (dynCall_iiiiji = Module.dynCall_iiiiji = Module.asm.pd).apply(null, arguments)
        }),
        dynCall_iiiij = (Module.dynCall_iiiij = function () {
          return (dynCall_iiiij = Module.dynCall_iiiij = Module.asm.qd).apply(null, arguments)
        }),
        dynCall_j = (Module.dynCall_j = function () {
          return (dynCall_j = Module.dynCall_j = Module.asm.rd).apply(null, arguments)
        }),
        dynCall_iiiiij = (Module.dynCall_iiiiij = function () {
          return (dynCall_iiiiij = Module.dynCall_iiiiij = Module.asm.sd).apply(null, arguments)
        }),
        dynCall_jji = (Module.dynCall_jji = function () {
          return (dynCall_jji = Module.dynCall_jji = Module.asm.td).apply(null, arguments)
        }),
        dynCall_viij = (Module.dynCall_viij = function () {
          return (dynCall_viij = Module.dynCall_viij = Module.asm.ud).apply(null, arguments)
        }),
        dynCall_viiiijii = (Module.dynCall_viiiijii = function () {
          return (dynCall_viiiijii = Module.dynCall_viiiijii = Module.asm.vd).apply(null, arguments)
        }),
        dynCall_jii = (Module.dynCall_jii = function () {
          return (dynCall_jii = Module.dynCall_jii = Module.asm.wd).apply(null, arguments)
        }),
        dynCall_jiii = (Module.dynCall_jiii = function () {
          return (dynCall_jiii = Module.dynCall_jiii = Module.asm.xd).apply(null, arguments)
        }),
        ...
        dynCall_viiijj = (Module.dynCall_viiijj = function () {
          return (dynCall_viiijj = Module.dynCall_viiijj = Module.asm.zd).apply(null, arguments)
        }),
        dynCall_iiji = (Module.dynCall_iiji = function () {
          return (dynCall_iiji = Module.dynCall_iiji = Module.asm.Ad).apply(null, arguments)
        }),
        dynCall_jiji = (Module.dynCall_jiji = function () {
          return (dynCall_jiji = Module.dynCall_jiji = Module.asm.Bd).apply(null, arguments)
        }),
        dynCall_jjii = (Module.dynCall_jjii = function () {
          return (dynCall_jjii = Module.dynCall_jjii = Module.asm.Cd).apply(null, arguments)
        }),
        dynCall_jjiiiiii = (Module.dynCall_jjiiiiii = function () {
          return (dynCall_jjiiiiii = Module.dynCall_jjiiiiii = Module.asm.Dd).apply(null, arguments)
        }),
        dynCall_viiiijj = (Module.dynCall_viiiijj = function () {
          return (dynCall_viiiijj = Module.dynCall_viiiijj = Module.asm.Ed).apply(null, arguments)
        }),
        dynCall_iiiijj = (Module.dynCall_iiiijj = function () {
          return (dynCall_iiiijj = Module.dynCall_iiiijj = Module.asm.Fd).apply(null, arguments)
        }),
        dynCall_viiij = (Module.dynCall_viiij = function () {
          return (dynCall_viiij = Module.dynCall_viiij = Module.asm.Gd).apply(null, arguments)
        }),
        dynCall_viiiiiijji = (Module.dynCall_viiiiiijji = function () {
          return (dynCall_viiiiiijji = Module.dynCall_viiiiiijji = Module.asm.Hd).apply(null, arguments)
        }),
        dynCall_viiijjj = (Module.dynCall_viiijjj = function () {
          return (dynCall_viiijjj = Module.dynCall_viiijjj = Module.asm.Id).apply(null, arguments)
        }),
        dynCall_vijiiii = (Module.dynCall_vijiiii = function () {
          return (dynCall_vijiiii = Module.dynCall_vijiiii = Module.asm.Jd).apply(null, arguments)
        }),
        dynCall_vijiiiii = (Module.dynCall_vijiiiii = function () {
          return (dynCall_vijiiiii = Module.dynCall_vijiiiii = Module.asm.Kd).apply(null, arguments)
        }),
        dynCall_viiiji = (Module.dynCall_viiiji = function () {
          return (dynCall_viiiji = Module.dynCall_viiiji = Module.asm.Ld).apply(null, arguments)
        }),
        dynCall_ijiiiii = (Module.dynCall_ijiiiii = function () {
          return (dynCall_ijiiiii = Module.dynCall_ijiiiii = Module.asm.Md).apply(null, arguments)
        }),
        dynCall_iji = (Module.dynCall_iji = function () {
          return (dynCall_iji = Module.dynCall_iji = Module.asm.Nd).apply(null, arguments)
        }),
        dynCall_viijiiii = (Module.dynCall_viijiiii = function () {
          return (dynCall_viijiiii = Module.dynCall_viijiiii = Module.asm.Od).apply(null, arguments)
        }),
        dynCall_jij = (Module.dynCall_jij = function () {
          return (dynCall_jij = Module.dynCall_jij = Module.asm.Pd).apply(null, arguments)
        }),
        dynCall_viji = (Module.dynCall_viji = function () {
          return (dynCall_viji = Module.dynCall_viji = Module.asm.Qd).apply(null, arguments)
        }),
        dynCall_iiiiijj = (Module.dynCall_iiiiijj = function () {
          return (dynCall_iiiiijj = Module.dynCall_iiiiijj = Module.asm.Rd).apply(null, arguments)
        }),
        dynCall_iiiiiijj = (Module.dynCall_iiiiiijj = function () {
          return (dynCall_iiiiiijj = Module.dynCall_iiiiiijj = Module.asm.Sd).apply(null, arguments)
        }),
        calledRun
      function invoke_iii(g, A, I) {
        var C = stackSave()
        try {
          return wasmTable.get(g)(A, I)
        } catch (g) {
          if ((stackRestore(C), g !== g + 0 && 'longjmp' !== g)) throw g
          _setThrew(1, 0)
        }
      }
      function invoke_viiiiiiiiiii(g, A, I, C, e, t, n, i, r, o, a, l) {
        var c = stackSave()
        try {
          wasmTable.get(g)(A, I, C, e, t, n, i, r, o, a, l)
        } catch (g) {
          if ((stackRestore(c), g !== g + 0 && 'longjmp' !== g)) throw g
          _setThrew(1, 0)
        }
      }
      function invoke_viii(g, A, I, C) {
        var e = stackSave()
        try {
          wasmTable.get(g)(A, I, C)
        } catch (g) {
          if ((stackRestore(e), g !== g + 0 && 'longjmp' !== g)) throw g
          _setThrew(1, 0)
        }
      }
      function invoke_vii(g, A, I) {
        var C = stackSave()
        try {
          wasmTable.get(g)(A, I)
        } catch (g) {
      ...
      function invoke_vi(g, A) {
        var I = stackSave()
        try {
          wasmTable.get(g)(A)
        } catch (g) {
          if ((stackRestore(I), g !== g + 0 && 'longjmp' !== g)) throw g
          _setThrew(1, 0)
        }
      }
      function invoke_viiifiiii(g, A, I, C, e, t, n, i, r) {
        var o = stackSave()
        try {
          wasmTable.get(g)(A, I, C, e, t, n, i, r)
        } catch (g) {
          if ((stackRestore(o), g !== g + 0 && 'longjmp' !== g)) throw g
          _setThrew(1, 0)
        }
      }
      function invoke_ii(g, A) {
        var I = stackSave()
        try {
          return wasmTable.get(g)(A)
        } catch (g) {
          if ((stackRestore(I), g !== g + 0 && 'longjmp' !== g)) throw g
          _setThrew(1, 0)
        }
      }
      function invoke_viiiifiii(g, A, I, C, e, t, n, i, r) {
        var o = stackSave()
        try {
          wasmTable.get(g)(A, I, C, e, t, n, i, r)
        } catch (g) {
      ...
      function invoke_viiii(g, A, I, C, e) {
        var t = stackSave()
        try {
          wasmTable.get(g)(A, I, C, e)
        } catch (g) {
          if ((stackRestore(t), g !== g + 0 && 'longjmp' !== g)) throw g
          _setThrew(1, 0)
        }
      }
      function invoke_viiiiiiii(g, A, I, C, e, t, n, i, r) {
        var o = stackSave()
        try {
          wasmTable.get(g)(A, I, C, e, t, n, i, r)
        } catch (g) {
      ...
      function invoke_viiiiii(g, A, I, C, e, t, n) {
        var i = stackSave()
        try {
          wasmTable.get(g)(A, I, C, e, t, n)
        } catch (g) {
          if ((stackRestore(i), g !== g + 0 && 'longjmp' !== g)) throw g
          _setThrew(1, 0)
        }
      }
      function invoke_iiii(g, A, I, C) {
        var e = stackSave()
        try {
          return wasmTable.get(g)(A, I, C)
        } catch (g) {
          if ((stackRestore(e), g !== g + 0 && 'longjmp' !== g)) throw g
          _setThrew(1, 0)
        }
      ...
      function invoke_v(g) {
        ...
        try {
          ...
          if ((stackRestore(A), g !== g + 0 && 'longjmp' !== g)) throw g
          _setThrew(1, 0)
        }
      }
      function invoke_iiiiii(g, A, I, C, e, t) {
        var n = stackSave()
        try {
          return wasmTable.get(g)(A, I, C, e, t)
        } catch (g) {
          if ((stackRestore(n), g !== g + 0 && 'longjmp' !== g)) throw g
          _setThrew(1, 0)
        }
      }
      function invoke_viiiii(g, A, I, C, e, t) {
        var n = stackSave()
        try {
          wasmTable.get(g)(A, I, C, e, t)
        } catch (g) {
          if ((stackRestore(n), g !== g + 0 && 'longjmp' !== g)) throw g
          _setThrew(1, 0)
        }
      }
      function invoke_iiiiiii(g, A, I, C, e, t, n) {
        var i = stackSave()
        try {
          return wasmTable.get(g)(A, I, C, e, t, n)
        } catch (g) {
          if ((stackRestore(i), g !== g + 0 && 'longjmp' !== g)) throw g
          _setThrew(1, 0)
        }
      }
      function invoke_iiiii(g, A, I, C, e) {
        var t = stackSave()
        try {
          return wasmTable.get(g)(A, I, C, e)
        } catch (g) {
          if ((stackRestore(t), g !== g + 0 && 'longjmp' !== g)) throw g
          _setThrew(1, 0)
        }
      }
      function invoke_viiiif(g, A, I, C, e, t) {
        var n = stackSave()
        try {
          wasmTable.get(g)(A, I, C, e, t)
        } catch (g) {
      ...
      function invoke_i(g) {
        var A = stackSave()
        try {
          return wasmTable.get(g)()
        } catch (g) {
          if ((stackRestore(A), g !== g + 0 && 'longjmp' !== g)) throw g
          _setThrew(1, 0)
        }
      }
      function invoke_fi(g, A) {
        var I = stackSave()
        try {
          return wasmTable.get(g)(A)
        } catch (g) {
      ...
      function invoke_viiif(g, A, I, C, e) {
        var t = stackSave()
        try {
          wasmTable.get(g)(A, I, C, e)
        } catch (g) {
      ...
      function invoke_viiiiiii(g, A, I, C, e, t, n, i) {
        var r = stackSave()
        try {
          wasmTable.get(g)(A, I, C, e, t, n, i)
        } catch (g) {
          if ((stackRestore(r), g !== g + 0 && 'longjmp' !== g)) throw g
          _setThrew(1, 0)
        }
      }
      function invoke_iiiiiiii(g, A, I, C, e, t, n, i) {
        var r = stackSave()
        try {
          return wasmTable.get(g)(A, I, C, e, t, n, i)
        } catch (g) {
          if ((stackRestore(r), g !== g + 0 && 'longjmp' !== g)) throw g
          _setThrew(1, 0)
        }
      }
      function invoke_iiiif(g, A, I, C, e) {
        var t = stackSave()
        try {
          return wasmTable.get(g)(A, I, C, e)
        } catch (g) {
      ...
      function invoke_viiiffi(g, A, I, C, e, t, n) {
        var i = stackSave()
        try {
          wasmTable.get(g)(A, I, C, e, t, n)
        } catch (g) {
      ...
      function invoke_viffff(g, A, I, C, e, t) {
        var n = stackSave()
        try {
          wasmTable.get(g)(A, I, C, e, t)
        } catch (g) {
      ...
      function invoke_viiiiiiifiii(g, A, I, C, e, t, n, i, r, o, a, l) {
        var c = stackSave()
        try {
          wasmTable.get(g)(A, I, C, e, t, n, i, r, o, a, l)
        } catch (g) {
      ...
      function invoke_viiifi(g, A, I, C, e, t) {
        var n = stackSave()
        try {
          wasmTable.get(g)(A, I, C, e, t)
        } catch (g) {
      ...
      function invoke_viiiiiiiii(g, A, I, C, e, t, n, i, r, o) {
        var a = stackSave()
        try {
          wasmTable.get(g)(A, I, C, e, t, n, i, r, o)
        } catch (g) {
          if ((stackRestore(a), g !== g + 0 && 'longjmp' !== g)) throw g
          _setThrew(1, 0)
        }
      }
      function invoke_iif(g, A, I) {
        var C = stackSave()
        try {
          return wasmTable.get(g)(A, I)
        } catch (g) {
      ...
      function invoke_iiiffff(g, A, I, C, e, t, n) {
        var i = stackSave()
        try {
          return wasmTable.get(g)(A, I, C, e, t, n)
        } catch (g) {
      ...
      function invoke_viifii(g, A, I, C, e, t) {
        var n = stackSave()
        try {
          wasmTable.get(g)(A, I, C, e, t)
        } catch (g) {
      ...
      function invoke_viiiiiiiiiiii(g, A, I, C, e, t, n, i, r, o, a, l, c) {
        var d = stackSave()
        try {
          wasmTable.get(g)(A, I, C, e, t, n, i, r, o, a, l, c)
        } catch (g) {
          if ((stackRestore(d), g !== g + 0 && 'longjmp' !== g)) throw g
          _setThrew(1, 0)
        }
      }
      function invoke_viiiiiiiiii(g, A, I, C, e, t, n, i, r, o, a) {
        var l = stackSave()
        try {
          wasmTable.get(g)(A, I, C, e, t, n, i, r, o, a)
        } catch (g) {
          if ((stackRestore(l), g !== g + 0 && 'longjmp' !== g)) throw g
          _setThrew(1, 0)
        }
      }
      function invoke_viiifiiiiiii(g, A, I, C, e, t, n, i, r, o, a, l) {
        var c = stackSave()
        try {
          wasmTable.get(g)(A, I, C, e, t, n, i, r, o, a, l)
        } catch (g) {
      ...
      function invoke_viiiiiif(g, A, I, C, e, t, n, i) {
        var r = stackSave()
        try {
          wasmTable.get(g)(A, I, C, e, t, n, i)
        } catch (g) {
      ...
      function invoke_vifiiiiiiif(g, A, I, C, e, t, n, i, r, o, a) {
        var l = stackSave()
        try {
          wasmTable.get(g)(A, I, C, e, t, n, i, r, o, a)
        } catch (g) {
      ...
      function invoke_viiiiiiiiiiiiii(g, A, I, C, e, t, n, i, r, o, a, l, c, d, s) {
        var u = stackSave()
        try {
          wasmTable.get(g)(A, I, C, e, t, n, i, r, o, a, l, c, d, s)
        } catch (g) {
          if ((stackRestore(u), g !== g + 0 && 'longjmp' !== g)) throw g
          _setThrew(1, 0)
        }
      }
      function invoke_vifii(g, A, I, C, e) {
        var t = stackSave()
        try {
          wasmTable.get(g)(A, I, C, e)
        } catch (g) {
      ...
      function invoke_iifii(g, A, I, C, e) {
        var t = stackSave()
        try {
          return wasmTable.get(g)(A, I, C, e)
        } catch (g) {
      ...
      function invoke_iiffi(g, A, I, C, e) {
        var t = stackSave()
        try {
          return wasmTable.get(g)(A, I, C, e)
        } catch (g) {
      ...
      function invoke_viiiifii(g, A, I, C, e, t, n, i) {
        var r = stackSave()
        try {
          wasmTable.get(g)(A, I, C, e, t, n, i)
        } catch (g) {
      ...
      function invoke_viiifii(g, A, I, C, e, t, n) {
        var i = stackSave()
        try {
          wasmTable.get(g)(A, I, C, e, t, n)
        } catch (g) {
      ...
      function invoke_viiiiifiiiii(g, A, I, C, e, t, n, i, r, o, a, l) {
        var c = stackSave()
        try {
          wasmTable.get(g)(A, I, C, e, t, n, i, r, o, a, l)
        } catch (g) {
      ...
      function invoke_viiiifi(g, A, I, C, e, t, n) {
        var i = stackSave()
        try {
          wasmTable.get(g)(A, I, C, e, t, n)
        } catch (g) {
      ...
      function invoke_iiiiiiiii(g, A, I, C, e, t, n, i, r) {
        var o = stackSave()
        try {
          return wasmTable.get(g)(A, I, C, e, t, n, i, r)
        } catch (g) {
          if ((stackRestore(o), g !== g + 0 && 'longjmp' !== g)) throw g
          _setThrew(1, 0)
        }
      }
      function invoke_iiiiiiiiii(g, A, I, C, e, t, n, i, r, o) {
        var a = stackSave()
        try {
          return wasmTable.get(g)(A, I, C, e, t, n, i, r, o)
        } catch (g) {
          if ((stackRestore(a), g !== g + 0 && 'longjmp' !== g)) throw g
          _setThrew(1, 0)
        }
      }
      function invoke_dii(g, A, I) {
        var C = stackSave()
        try {
          return wasmTable.get(g)(A, I)
        } catch (g) {
      ...
      function invoke_iiiiiiiiiii(g, A, I, C, e, t, n, i, r, o, a) {
        var l = stackSave()
        try {
          return wasmTable.get(g)(A, I, C, e, t, n, i, r, o, a)
        } catch (g) {
          if ((stackRestore(l), g !== g + 0 && 'longjmp' !== g)) throw g
          _setThrew(1, 0)
        }
      }
      function invoke_idii(g, A, I, C) {
        var e = stackSave()
        try {
          return wasmTable.get(g)(A, I, C)
        } catch (g) {
      ...
      function invoke_viifi(g, A, I, C, e) {
        var t = stackSave()
        try {
          wasmTable.get(g)(A, I, C, e)
        } catch (g) {
      ...
      function invoke_vidddd(g, A, I, C, e, t) {
        var n = stackSave()
        try {
          wasmTable.get(g)(A, I, C, e, t)
        } catch (g) {
      ...
      function invoke_viiiiiiffff(g, A, I, C, e, t, n, i, r, o, a) {
        var l = stackSave()
        try {
          wasmTable.get(g)(A, I, C, e, t, n, i, r, o, a)
        } catch (g) {
      ...
      function invoke_iiffffffff(g, A, I, C, e, t, n, i, r, o) {
        var a = stackSave()
        try {
          return wasmTable.get(g)(A, I, C, e, t, n, i, r, o)
        } catch (g) {
      ...
      function invoke_viffffffff(g, A, I, C, e, t, n, i, r, o) {
        var a = stackSave()
        try {
          wasmTable.get(g)(A, I, C, e, t, n, i, r, o)
        } catch (g) {
      ...
      function invoke_iiiiiiifi(g, A, I, C, e, t, n, i, r) {
        var o = stackSave()
        try {
          return wasmTable.get(g)(A, I, C, e, t, n, i, r)
        } catch (g) {
      ...
      function invoke_fiiiii(g, A, I, C, e, t) {
        var n = stackSave()
        try {
          return wasmTable.get(g)(A, I, C, e, t)
        } catch (g) {
      ...
      function invoke_viiiiff(g, A, I, C, e, t, n) {
        var i = stackSave()
        try {
          wasmTable.get(g)(A, I, C, e, t, n)
        } catch (g) {
      ...
      function invoke_iiifiii(g, A, I, C, e, t, n) {
        var i = stackSave()
        try {
          return wasmTable.get(g)(A, I, C, e, t, n)
        } catch (g) {
      ...
      function invoke_viiiiiiiiiiiii(g, A, I, C, e, t, n, i, r, o, a, l, c, d) {
        var s = stackSave()
        try {
          wasmTable.get(g)(A, I, C, e, t, n, i, r, o, a, l, c, d)
        } catch (g) {
          if ((stackRestore(s), g !== g + 0 && 'longjmp' !== g)) throw g
          _setThrew(1, 0)
        }
      }
      function invoke_iiiiiiiiiiiiii(g, A, I, C, e, t, n, i, r, o, a, l, c, d) {
        var s = stackSave()
        try {
          return wasmTable.get(g)(A, I, C, e, t, n, i, r, o, a, l, c, d)
        } catch (g) {
          if ((stackRestore(s), g !== g + 0 && 'longjmp' !== g)) throw g
          _setThrew(1, 0)
        }
      }
      function invoke_iiiiiiiiiiiiiii(g, A, I, C, e, t, n, i, r, o, a, l, c, d, s) {
        var u = stackSave()
        try {
          return wasmTable.get(g)(A, I, C, e, t, n, i, r, o, a, l, c, d, s)
        } catch (g) {
          if ((stackRestore(u), g !== g + 0 && 'longjmp' !== g)) throw g
          _setThrew(1, 0)
        }
      }
      function invoke_fiiii(g, A, I, C, e) {
        var t = stackSave()
        try {
          return wasmTable.get(g)(A, I, C, e)
        } catch (g) {
      ...
      function invoke_iiiifiii(g, A, I, C, e, t, n, i) {
        var r = stackSave()
        try {
          return wasmTable.get(g)(A, I, C, e, t, n, i)
        } catch (g) {
      ...
      function invoke_iiiiiiiiiiii(g, A, I, C, e, t, n, i, r, o, a, l) {
        var c = stackSave()
        try {
          return wasmTable.get(g)(A, I, C, e, t, n, i, r, o, a, l)
        } catch (g) {
          if ((stackRestore(c), g !== g + 0 && 'longjmp' !== g)) throw g
          _setThrew(1, 0)
        }
      }
      function invoke_viiiiiiiiiiiiiii(g, A, I, C, e, t, n, i, r, o, a, l, c, d, s, u) {
        var m = stackSave()
        try {
          wasmTable.get(g)(A, I, C, e, t, n, i, r, o, a, l, c, d, s, u)
        } catch (g) {
          if ((stackRestore(m), g !== g + 0 && 'longjmp' !== g)) throw g
          _setThrew(1, 0)
        }
      }
      function invoke_fiii(g, A, I, C) {
        var e = stackSave()
        try {
          return wasmTable.get(g)(A, I, C)
        } catch (g) {
      ...
      function invoke_iiiiid(g, A, I, C, e, t) {
        var n = stackSave()
        try {
          return wasmTable.get(g)(A, I, C, e, t)
        } catch (g) {
      ...
      function invoke_viijj(g, A, I, C, e, t, n) {
        var i = stackSave()
        try {
          dynCall_viijj(g, A, I, C, e, t, n)
        } catch (g) {
          if ((stackRestore(i), g !== g + 0 && 'longjmp' !== g)) throw g
          _setThrew(1, 0)
        }
      }
      function invoke_vij(g, A, I, C) {
        var e = stackSave()
        try {
          dynCall_vij(g, A, I, C)
        } catch (g) {
      ...
      function invoke_ji(g, A) {
        var I = stackSave()
        try {
          return dynCall_ji(g, A)
        } catch (g) {
          if ((stackRestore(I), g !== g + 0 && 'longjmp' !== g)) throw g
          _setThrew(1, 0)
        }
      }
      function invoke_iij(g, A, I, C) {
        var e = stackSave()
        try {
          return dynCall_iij(g, A, I, C)
        } catch (g) {
          if ((stackRestore(e), g !== g + 0 && 'longjmp' !== g)) throw g
          _setThrew(1, 0)
        }
      }
      function invoke_iiiiji(g, A, I, C, e, t, n) {
        var i = stackSave()
        try {
          return dynCall_iiiiji(g, A, I, C, e, t, n)
        } catch (g) {
          if ((stackRestore(i), g !== g + 0 && 'longjmp' !== g)) throw g
          _setThrew(1, 0)
        }
      }
      function invoke_iiij(g, A, I, C, e) {
        var t = stackSave()
        try {
          return dynCall_iiij(g, A, I, C, e)
        } catch (g) {
          if ((stackRestore(t), g !== g + 0 && 'longjmp' !== g)) throw g
          _setThrew(1, 0)
        }
      }
      function invoke_iiiij(g, A, I, C, e, t) {
        var n = stackSave()
        try {
          return dynCall_iiiij(g, A, I, C, e, t)
        } catch (g) {
          if ((stackRestore(n), g !== g + 0 && 'longjmp' !== g)) throw g
          _setThrew(1, 0)
        }
      }
      function invoke_jji(g, A, I, C) {
        var e = stackSave()
        try {
          return dynCall_jji(g, A, I, C)
        } catch (g) {
          if ((stackRestore(e), g !== g + 0 && 'longjmp' !== g)) throw g
          _setThrew(1, 0)
        }
      }
      function invoke_viij(g, A, I, C, e) {
        var t = stackSave()
        try {
          dynCall_viij(g, A, I, C, e)
        } catch (g) {
          if ((stackRestore(t), g !== g + 0 && 'longjmp' !== g)) throw g
          _setThrew(1, 0)
        }
      }
      function invoke_viiiijii(g, A, I, C, e, t, n, i, r) {
        var o = stackSave()
        try {
          dynCall_viiiijii(g, A, I, C, e, t, n, i, r)
        } catch (g) {
          if ((stackRestore(o), g !== g + 0 && 'longjmp' !== g)) throw g
          _setThrew(1, 0)
        }
      }
      function invoke_jii(g, A, I) {
        var C = stackSave()
        try {
          return dynCall_jii(g, A, I)
        } catch (g) {
          if ((stackRestore(C), g !== g + 0 && 'longjmp' !== g)) throw g
          _setThrew(1, 0)
        }
      }
      function invoke_jiii(g, A, I, C) {
        var e = stackSave()
        try {
          return dynCall_jiii(g, A, I, C)
        } catch (g) {
          if ((stackRestore(e), g !== g + 0 && 'longjmp' !== g)) throw g
          _setThrew(1, 0)
        }
      }
      function invoke_viiijj(g, A, I, C, e, t, n, i) {
        var r = stackSave()
        try {
          dynCall_viiijj(g, A, I, C, e, t, n, i)
        } catch (g) {
          if ((stackRestore(r), g !== g + 0 && 'longjmp' !== g)) throw g
          _setThrew(1, 0)
        }
      ...
      function invoke_iiji(g, A, I, C, e) {
        var t = stackSave()
        try {
          return dynCall_iiji(g, A, I, C, e)
        } catch (g) {
          if ((stackRestore(t), g !== g + 0 && 'longjmp' !== g)) throw g
          _setThrew(1, 0)
        }
      }
      function invoke_jjii(g, A, I, C, e) {
        var t = stackSave()
        try {
          return dynCall_jjii(g, A, I, C, e)
        } catch (g) {
          if ((stackRestore(t), g !== g + 0 && 'longjmp' !== g)) throw g
          _setThrew(1, 0)
        }
      }
      function invoke_jjiiiiii(g, A, I, C, e, t, n, i, r) {
        var o = stackSave()
        try {
          return dynCall_jjiiiiii(g, A, I, C, e, t, n, i, r)
        } catch (g) {
          if ((stackRestore(o), g !== g + 0 && 'longjmp' !== g)) throw g
          _setThrew(1, 0)
        }
      }
      function invoke_viiiijj(g, A, I, C, e, t, n, i, r) {
        var o = stackSave()
        try {
          dynCall_viiiijj(g, A, I, C, e, t, n, i, r)
        } catch (g) {
          if ((stackRestore(o), g !== g + 0 && 'longjmp' !== g)) throw g
          _setThrew(1, 0)
        }
      }
      function invoke_viiij(g, A, I, C, e, t) {
        var n = stackSave()
        try {
          dynCall_viiij(g, A, I, C, e, t)
        } catch (g) {
          if ((stackRestore(n), g !== g + 0 && 'longjmp' !== g)) throw g
          _setThrew(1, 0)
        }
      }
      function invoke_iiiiij(g, A, I, C, e, t, n) {
        var i = stackSave()
        try {
          return dynCall_iiiiij(g, A, I, C, e, t, n)
        } catch (g) {
          if ((stackRestore(i), g !== g + 0 && 'longjmp' !== g)) throw g
          _setThrew(1, 0)
        }
      }
      function invoke_viiiiiijji(g, A, I, C, e, t, n, i, r, o, a, l) {
        var c = stackSave()
        try {
          dynCall_viiiiiijji(g, A, I, C, e, t, n, i, r, o, a, l)
        } catch (g) {
          if ((stackRestore(c), g !== g + 0 && 'longjmp' !== g)) throw g
          _setThrew(1, 0)
        }
      }
      function invoke_viijii(g, A, I, C, e, t, n) {
        var i = stackSave()
        try {
          dynCall_viijii(g, A, I, C, e, t, n)
        } catch (g) {
          if ((stackRestore(i), g !== g + 0 && 'longjmp' !== g)) throw g
          _setThrew(1, 0)
        }
      }
      function invoke_viiijjj(g, A, I, C, e, t, n, i, r, o) {
        var a = stackSave()
        try {
          dynCall_viiijjj(g, A, I, C, e, t, n, i, r, o)
        } catch (g) {
          if ((stackRestore(a), g !== g + 0 && 'longjmp' !== g)) throw g
          _setThrew(1, 0)
        }
      }
      function invoke_vijiiii(g, A, I, C, e, t, n, i) {
        var r = stackSave()
        try {
          dynCall_vijiiii(g, A, I, C, e, t, n, i)
        } catch (g) {
          if ((stackRestore(r), g !== g + 0 && 'longjmp' !== g)) throw g
          _setThrew(1, 0)
        }
      }
      function invoke_vijiiiii(g, A, I, C, e, t, n, i, r) {
        var o = stackSave()
        try {
          dynCall_vijiiiii(g, A, I, C, e, t, n, i, r)
        } catch (g) {
          if ((stackRestore(o), g !== g + 0 && 'longjmp' !== g)) throw g
          _setThrew(1, 0)
        }
      }
      function invoke_viiiji(g, A, I, C, e, t, n) {
        var i = stackSave()
        try {
          dynCall_viiiji(g, A, I, C, e, t, n)
        } catch (g) {
          if ((stackRestore(i), g !== g + 0 && 'longjmp' !== g)) throw g
          _setThrew(1, 0)
        }
      }
      function invoke_ijiiiii(g, A, I, C, e, t, n, i) {
        var r = stackSave()
        try {
          return dynCall_ijiiiii(g, A, I, C, e, t, n, i)
        } catch (g) {
          if ((stackRestore(r), g !== g + 0 && 'longjmp' !== g)) throw g
          _setThrew(1, 0)
        }
      }
      function invoke_iiiijj(g, A, I, C, e, t, n, i) {
        var r = stackSave()
        try {
          return dynCall_iiiijj(g, A, I, C, e, t, n, i)
        } catch (g) {
          if ((stackRestore(r), g !== g + 0 && 'longjmp' !== g)) throw g
          _setThrew(1, 0)
        }
      }
      function invoke_viijiiii(g, A, I, C, e, t, n, i, r) {
        var o = stackSave()
        try {
          dynCall_viijiiii(g, A, I, C, e, t, n, i, r)
        } catch (g) {
          if ((stackRestore(o), g !== g + 0 && 'longjmp' !== g)) throw g
          _setThrew(1, 0)
        }
      }
      function ExitStatus(g) {
      ...
      function exit(g, A) {
        ;(EXITSTATUS = g), keepRuntimeAlive() || exitRuntime(), procExit(g)
      }
      function procExit(g) {
        ;(EXITSTATUS = g),
          keepRuntimeAlive() || (Module.onExit && Module.onExit(g), (ABORT = !0)),
          quit_(g, new ExitStatus(g))
      }
      if (
        ...
        (Module.FS_unlink = FS.unlink),
        (Module.FS = FS),
        (dependenciesFulfilled = function g() {
          calledRun || run(), calledRun || (dependenciesFulfilled = g)
        }),
        (Module.run = run),
        Module.preInit)
      )
        for ('function' == typeof Module.preInit && (Module.preInit = [Module.preInit]); Module.preInit.length > 0; )
          Module.preInit.pop()()
      return run(), PSPDFModuleInit.ready
    }
  )
})()
'object' == typeof exports && 'object' == typeof module
  ...
  : 'object' == typeof exports && (exports.PSPDFModuleInit = PSPDFModuleInit)
